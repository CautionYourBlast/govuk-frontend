...
import scotGovCookieBanner from './scot-gov-cookie-banner.mjs';
...
describe('cookie notification banners', () => {
    ...
    it('should show the cookie notification if it has not already been dismissed', () => {
        ...
        testObj.cookieNotificationModule = new scotGovCookieBanner(testObj.cookieNotificationElement, storage);
    ...
    it('should use the non-mock storage module by default', () => {
        testObj.cookieNotificationModule = new scotGovCookieBanner(testObj.cookieNotificationElement);
        testObj.cookieNotificationModule.init();
