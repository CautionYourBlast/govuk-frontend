...
export class Header extends GOVUKFrontendComponent {
  ...
  constructor($module) {
    ...
    this.$module = $module
    const $menuButton = $module.querySelector('.ds_js-header-toggle')
    ...
    if (!menuId) {
      throw new ElementError({
        componentName: 'Header',
        identifier:
          'Navigation button (`<button class="ds_js-header-toggle">`) attribute (`aria-controls`)'
      })
    }
    ...
    // Set the matchMedia to the ds_frontend desktop breakpoint
