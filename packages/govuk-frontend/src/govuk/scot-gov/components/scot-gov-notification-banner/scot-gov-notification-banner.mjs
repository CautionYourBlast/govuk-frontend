 ...
 * @preserve
 */
export class scotGovNotificationBanner extends GOVUKFrontendComponent {
  /** @private */
  $module

  /**
   * @private
   * @type {scotGovNotificationBannerConfig}
   */
  config

  /**
   * @param {Element | null} $module - HTML element to use for notification banner
   * @param {scotGovNotificationBannerConfig} [config] - Notification banner config
   */
  constructor($module, config = {}) {
    ...
    this.config = mergeConfigs(
      scotGovNotificationBanner.defaults,
      config,
   ...
   *
   * @see {@link scotGovNotificationBannerConfig}
   * @constant
   * @type {scotGovNotificationBannerConfig}
   */
 ...
 *
 * @typedef {object} scotGovNotificationBannerConfig
