...
describe('fieldset', () => {
  ...
  it('creates a fieldset', () => {
    ...
    const $component = $('fieldset.ds_fieldset')
  ...
  it('includes a legend element which captions the fieldset', () => {
    ...
    const $legend = $('.ds_fieldset__legend')
  ...
  it('nests the legend text in an H1 if the legend is a page heading', () => {
    ...
    const $headingInsideLegend = $('.ds_fieldset__legend > h1')
  ...
  it('renders html when passed as fieldset content', () => {
    ...
    expect($('.ds_fieldset .my-content').text().trim()).toEqual(
  ...
  it('renders nested components using `call`', () => {
    ...
    expect($('.ds_fieldset .app-nested-component').length).toBeTruthy()
  })
