...
The precompiled CSS and JavaScript files found in our [GitHub releases](https://github.com/CautionYourBlast/govuk-frontend/releases) are now also published to [`govuk-frontend` on npm](https://www.npmjs.com/package/govuk-frontend).

These changes were introduced in:

- [pull request #3726: Default to ES modules with single Rollup config](https://github.com/CautionYourBlast/govuk-frontend/pull/3726)
- [pull request #4241: Add new `govuk-frontend.min.css` package bundle](https://github.com/CautionYourBlast/govuk-frontend/pull/4241)
...
This change was made in [pull request #2261: Task list component](https://github.com/CautionYourBlast/govuk-frontend/pull/2261).
...
- [pull request #3502: Tag design changes](https://github.com/CautionYourBlast/govuk-frontend/pull/3502).
- [pull request #3731: Remove the first letter modifier from the tag component](https://github.com/CautionYourBlast/govuk-frontend/pull/3731)
- [pull request #4259: Add word breaking for long single word tags](https://github.com/CautionYourBlast/govuk-frontend/pull/4259)
...
This change was made in [pull request #3599: Enable new link styles by default](https://github.com/CautionYourBlast/govuk-frontend/pull/3599) and [pull request #3600: Remove new link styles feature flag](https://github.com/CautionYourBlast/govuk-frontend/pull/3600).
...
This change was made in [pull request #3819: Add linked image focus style](https://github.com/CautionYourBlast/govuk-frontend/pull/3819).
...
This change was made in [pull request #4043: Add ability to customise inverse button colours](https://github.com/CautionYourBlast/govuk-frontend/pull/4043).
...
This change was introduced in [pull request #4011: Remove component init() methods and initialise in constructor](https://github.com/CautionYourBlast/govuk-frontend/pull/4011).
...
This change was introduced in [pull request #3766: Remove JavaScript from Details component](https://github.com/CautionYourBlast/govuk-frontend/pull/3766).
...
- [#3491: Update Review app to import `govuk-frontend` via local package](https://github.com/CautionYourBlast/govuk-frontend/pull/3491)
- [#3498: Remove built `dist` and `package` from source](https://github.com/CautionYourBlast/govuk-frontend/pull/3498)
...
- [pull request #3622: Remove compatibility mode variables](https://github.com/CautionYourBlast/govuk-frontend/pull/3622)
- [pull request #3602: Remove `compatibility-mode` mixin](https://github.com/CautionYourBlast/govuk-frontend/pull/3602)
- [pull request #3576: Remove legacy colour palette](https://github.com/CautionYourBlast/govuk-frontend/pull/3576)
- [pull request #3574: Remove legacy and tabular fonts support](https://github.com/CautionYourBlast/govuk-frontend/pull/3574)
- [pull request #3576: Remove `$govuk-typography-use-rem` setting](https://github.com/CautionYourBlast/govuk-frontend/pull/3575)
...
This change was introduced in [pull request #2830: Set the boolean disabled attribute consistently in the button component](https://github.com/CautionYourBlast/govuk-frontend/pull/2830).

#### Check that the mobile menu button in the header component works as expected

We've removed some styles from the `.govuk-header__menu-button` class. These styles were included on the mobile menu button to avoid introducing a breaking change in [GOV.UK Frontend v4.3.0](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v4.3.0).
...
This change was introduced in [pull request #3596: Remove redundant display style from `.govuk-header__menu-button`](https://github.com/CautionYourBlast/govuk-frontend/pull/3596).
...
We've removed the `govuk-if-ie8` and `govuk-not-ie8` mixins, and the `$govuk-is-ie8` and `$govuk-ie8-breakpoint` settings, that were deprecated in [GOV.UK Frontend v4.6.0](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v4.6.0).

This change was introduced in [pull request #3559: Remove IE8-related Sass and CSS build tasks](https://github.com/CautionYourBlast/govuk-frontend/pull/3559).

#### Remove deprecated `.govuk-button--disabled` class

We've removed the `.govuk-button--disabled` class that we deprecated in [GOV.UK Frontend v4.6.0](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v4.6.0).
...
This change was introduced in [pull request #3557: Remove deprecated `.govuk-button--disabled` class](https://github.com/CautionYourBlast/govuk-frontend/pull/3557).

#### Remove deprecated `.govuk-!-margin-static` and `.govuk-!-padding-static` classes

We've removed the override classes starting with `.govuk-!-margin-static` and `.govuk-!-padding-static` which were deprecated in [GOV.UK Frontend v4.3.1](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v4.3.1).

Use the classes starting with `.govuk-!-static-margin` and `.govuk-!-static-padding` instead.

This change was introduced in [pull request #3593: Remove deprecated static spacing classes](https://github.com/CautionYourBlast/govuk-frontend/pull/3593).
...
This change was introduced in [pull request #3641: Remove fallback GOV.UK logo for IE8](https://github.com/CautionYourBlast/govuk-frontend/pull/3641).

#### Remove deprecated `.govuk-header__link--service-name` class

We've removed the `.govuk-header__link--service-name` class that we deprecated in [GOV.UK Frontend v4.2.0](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v4.2.0).

Use the `.govuk-header__service-name` class instead.

This change was introduced in [pull request #3594: Remove deprecated `.govuk-header__link--service-name` class](https://github.com/CautionYourBlast/govuk-frontend/pull/3594).

#### Remove deprecated `.govuk-header__navigation--no-service-name` class

We've removed the `.govuk-header__navigation--no-service-name` class that we deprecated in [GOV.UK Frontend v4.3.0](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v4.3.0).
...
This change was introduced in [pull request #3595: Remove deprecated `.govuk-header__navigation--no-service-name` class](https://github.com/CautionYourBlast/govuk-frontend/pull/3595).
...
This change was introduced in [pull request #3569: Remove unnecesary class from Warning Text component](https://github.com/CautionYourBlast/govuk-frontend/pull/3569).
...
This change was introduced in [pull request #3773: Omit the value attribute from select options with no value](https://github.com/CautionYourBlast/govuk-frontend/pull/3773).
...
This change was introduced in [pull request #3949: Simplify font family settings](https://github.com/CautionYourBlast/govuk-frontend/pull/3949).
...
- [pull request #3570: Remove IE8-10 JavaScript polyfills, helpers, config](https://github.com/CautionYourBlast/govuk-frontend/pull/3570)
- [pull request #3720: Remove IE11 vendor polyfills](https://github.com/CautionYourBlast/govuk-frontend/pull/3720)
...
This change was introduced in [pull request #3899: Update default `aria-label` in Pagination component](https://github.com/CautionYourBlast/govuk-frontend/pull/3899).
...
This change was introduced in [pull request #3989: Update default Exit This Page button text](https://github.com/CautionYourBlast/govuk-frontend/pull/3989).
...
This change was introduced in [pull request #4054: Add `rel` attribute to the Exit this Page button](https://github.com/CautionYourBlast/govuk-frontend/pull/4054). Thanks to [Greg Tyler](https://github.com/gregtyler) for reporting this issue.

### Fixes

We’ve made fixes to GOV.UK Frontend in the following pull requests:

- [#3777: Fix hover style on small checkboxes and radio buttons in High Contrast Mode](https://github.com/CautionYourBlast/govuk-frontend/pull/3777)
- [#3791: Refactor mobile menu button label/text handling](https://github.com/CautionYourBlast/govuk-frontend/pull/3791)
- [#3862: Fix focus style being overlapped by summary action links](https://github.com/CautionYourBlast/govuk-frontend/pull/3862)
- [#4113: Always set an explicit button `type`](https://github.com/CautionYourBlast/govuk-frontend/pull/4113)
- [#4267: Remove unnecessary duplicated use of govuk-font](https://github.com/CautionYourBlast/govuk-frontend/pull/4267)
- [#4268: Allow border and hover colours to be overridden](https://github.com/CautionYourBlast/govuk-frontend/pull/4268)
- [#4327: Fix Nunjucks `default()` values when `null`, `false` or `""` is provided](https://github.com/CautionYourBlast/govuk-frontend/pull/4327)
...
This was added in [pull request #2545: Add exit this page component](https://github.com/CautionYourBlast/govuk-frontend/pull/2545).
...
This change was made in [pull request #3556: Add inverse button styles](https://github.com/CautionYourBlast/govuk-frontend/pull/3556).
...
This change was made in [pull request #3774: Add inverse breadcrumb and back link modifiers and styles](https://github.com/CautionYourBlast/govuk-frontend/pull/3774).
...
- [#3817: Fix package resolution in Node.js 17+](https://github.com/CautionYourBlast/govuk-frontend/pull/3817)
- [#3836: Announce whitespace in screen reader announcements of visually hidden text](https://github.com/CautionYourBlast/govuk-frontend/pull/3836)
...
This was added in [pull request #3187: Add disabled styles for form controls](https://github.com/CautionYourBlast/govuk-frontend/pull/3187).
...
This was added in [pull request #3342: Add option to disable sessionState in Accordion](https://github.com/CautionYourBlast/govuk-frontend/pull/3342).
...
This was added in [pull request #3344: Adding optional ‘id’ attribute to button component](https://github.com/CautionYourBlast/govuk-frontend/pull/3344).
...
This was added in [pull request #2230: Add extra letter spacing modifier for inputs](https://github.com/CautionYourBlast/govuk-frontend/pull/2230)

### Deprecated features

#### Stop using JavaScript API properties other than the `init` method

We have deprecated all of the JavaScript properties in the API, except for the `init` method for each component. We'll make all of the deprecated JavaScript properties private in [our next main release](https://github.com/CautionYourBlast/govuk-frontend/milestone/46).
...
This was added in [pull request #3499: Deprecate all JavaScript instance properties the except `init` method](https://github.com/CautionYourBlast/govuk-frontend/pull/3499).
...
This was added in [pull request #3326: Deprecate `govuk-button--disabled` class](https://github.com/CautionYourBlast/govuk-frontend/pull/3326).
...
- [#3255: Including the JavaScript source map in the prototype kit config](https://github.com/CautionYourBlast/govuk-frontend/pull/3255)
- [#3272: Add empty alt attribute to logo IE8 fallback PNG](https://github.com/CautionYourBlast/govuk-frontend/pull/3272)
- [#3306: Re-enable complete hover link styles on the footer](https://github.com/CautionYourBlast/govuk-frontend/pull/3306)
- [#3312: Add default value for warning text icon fallback attribute](https://github.com/CautionYourBlast/govuk-frontend/pull/3312)
- [#3426: Add organisation brand colour for Department for Business & Trade](https://github.com/CautionYourBlast/govuk-frontend/pull/3426) - thanks to [Barbara Slawinska](https://github.com/baisa) for contributing this change
- [#3454: Update default link underline offset setting](https://github.com/CautionYourBlast/govuk-frontend/pull/3454)
...
This was added in [pull request #2931: Add summary card enhancement to summary list](https://github.com/CautionYourBlast/govuk-frontend/pull/2931).
...
- [#3053: Enhance the Accordion component with `hidden='until-found'`](https://github.com/CautionYourBlast/govuk-frontend/pull/3053)
- [#3095: Hide Accordion content (again) during `.js-enabled` page load](https://github.com/CautionYourBlast/govuk-frontend/pull/3095)
...
This was added in [pull request #3023: Add source maps to compiled JavaScript and CSS](https://github.com/CautionYourBlast/govuk-frontend/pull/3023).

### Fixes

We've fixed errors in IE8 caused by updates to our precompiled JavaScript. The issue prevented some polyfills from running, but was limited to the `release-v4.4.1.zip` and `release-v4.4.0.zip` assets on [GitHub releases](https://github.com/CautionYourBlast/govuk-frontend/releases):

- [#3137: Enable UglifyJS compatibility workarounds](https://github.com/CautionYourBlast/govuk-frontend/pull/3137)
- [#3013: Swap JavaScript minifier from UglifyJS to terser](https://github.com/CautionYourBlast/govuk-frontend/pull/3013)

We've made fixes to GOV.UK Frontend in the following pull requests:

- [#2998: Refactor back link and breadcrumb chevrons to use ems](https://github.com/CautionYourBlast/govuk-frontend/pull/2998)
- [#3021: Change colour for current page link in the header to improve contrast when printing](https://github.com/CautionYourBlast/govuk-frontend/pull/3021) - thanks to [Malcolm Butler](https://github.com/MalcolmVonMoJ) for the contribution
- [#3094: Fix Accordion margin/padding inconsistencies](https://github.com/CautionYourBlast/govuk-frontend/pull/3094)
- [#3112: Remove unused `classList` polyfill from header component JavaScript](https://github.com/CautionYourBlast/govuk-frontend/pull/3112)
- [#3150: Add missing `Event` polyfill to accordion component JavaScript](https://github.com/CautionYourBlast/govuk-frontend/pull/3150)
- [#3156: Correct the closing double quotes in pagination Nunjucks](https://github.com/CautionYourBlast/govuk-frontend/pull/3156) - thanks to [Joanna Pinto Paul](https://github.com/JoPintoPaul) for the contribution
- [#3199: Fix Sass rounding issues with width of grid columns](https://github.com/CautionYourBlast/govuk-frontend/pull/3199)
...
- [#3087: Fix focus styles for links split over multiple lines in Chromium 108+ (Chrome 108+, Edge 108+, Opera 94+)](https://github.com/CautionYourBlast/govuk-frontend/pull/3087)
...
This was added in [pull request #2752: Change the Button component background and text colour](https://github.com/CautionYourBlast/govuk-frontend/pull/2752). Thanks to [Nick Colley](https://github.com/NickColley) for this contribution.
...
This was added in [pull request #2720: Add parameter to localise mobile menu toggle button](https://github.com/CautionYourBlast/govuk-frontend/pull/2720).
...
This was added in [pull request #2742: Add ability to customise character count fallback text](https://github.com/CautionYourBlast/govuk-frontend/pull/2742), and the option renamed to `textareaDescriptionText` in [pull request #2915](https://github.com/CautionYourBlast/govuk-frontend/pull/2915).
...
- [#2895 Add macro options to configure CharacterCount translations](https://github.com/CautionYourBlast/govuk-frontend/pull/2895)
- [#2887 Allow CharacterCount component to receive i18n config via JS](https://github.com/CautionYourBlast/govuk-frontend/pull/2887)
...
This was added in [pull request #2915](https://github.com/CautionYourBlast/govuk-frontend/pull/2915).
...
- [#2818: Add support for localisation via data-\* attributes to Accordion component](https://github.com/CautionYourBlast/govuk-frontend/pull/2818)
- [#2826: Add support for localisation via JavaScript configuration to Accordion component](https://github.com/CautionYourBlast/govuk-frontend/pull/2826)
...
This was added in [#2911 Add warning suppression functionality](https://github.com/CautionYourBlast/govuk-frontend/pull/2911)
...
- [NotificationBanner – #2843](https://github.com/CautionYourBlast/govuk-frontend/pull/2843)
- [ErrorSummary – #2854](https://github.com/CautionYourBlast/govuk-frontend/pull/2854)
- [Button – #2867](https://github.com/CautionYourBlast/govuk-frontend/pull/2867)
- [CharacterCount – #2883](https://github.com/CautionYourBlast/govuk-frontend/pull/2883)
...
This was added in [pull request #2677: Amend error summary markup to fix page load focus bug in JAWS 2022](https://github.com/CautionYourBlast/govuk-frontend/pull/2677).
...
This was introduced in [pull request #2882: Deprecate compatibility mode settings](https://github.com/CautionYourBlast/govuk-frontend/pull/2882).
...
This was introduced in [pull request #2844: Remove compatibility mode from govuk-frontend](https://github.com/CautionYourBlast/govuk-frontend/pull/2844).

### Fixes

In [pull request 2851: Support Prototype Kit v13](https://github.com/CautionYourBlast/govuk-frontend/pull/2851) we've introduced support for the plugins system included in the upcoming Prototype Kit v13.

We've made fixes to GOV.UK Frontend in the following pull requests:

- [#2807: Tidy up and refactor the Character Count JavaScript](https://github.com/CautionYourBlast/govuk-frontend/pull/2807)
- [#2811: Use Element.id to get module id for accordion](https://github.com/CautionYourBlast/govuk-frontend/pull/2811)
- [#2821: Avoid duplicated --error class on Character Count](https://github.com/CautionYourBlast/govuk-frontend/pull/2821)
- [#2800: Improve Pagination component print styles](https://github.com/CautionYourBlast/govuk-frontend/pull/2800)
- [#2909: Fix JavaScript errors when entering text into the Character Count in IE8](https://github.com/CautionYourBlast/govuk-frontend/pull/2909)
...
This change was introduced in [pull request #2770: Fix ordering of properties in static spacing override classes](https://github.com/CautionYourBlast/govuk-frontend/pull/2770). Thanks to @garrystewart for reporting this issue.

### Fixes

We’ve made fixes to GOV.UK Frontend in the following pull requests:

- [#2766: Remove unused `console.log` calls from accordion JavaScript](https://github.com/CautionYourBlast/govuk-frontend/pull/2766)
...
This was added in [pull request #2673: Allow Open Graph image URL to be customised](https://github.com/CautionYourBlast/govuk-frontend/pull/2673).
...
This was added in [pull request #2702: Allow localisation of content licence and copyright notices in Footer](https://github.com/CautionYourBlast/govuk-frontend/pull/2702).
...
This was added in [pull request #2734: Update various components to be callable](https://github.com/CautionYourBlast/govuk-frontend/pull/2734).
...
This was added in [pull request #2672: Add static spacing override classes](https://github.com/CautionYourBlast/govuk-frontend/pull/2672). Thanks to @patrickpatrickpatrick for this contribution.
...
This was added in [pull request #2694: Deprecate .govuk-header\_\_navigation--no-service-name](https://github.com/CautionYourBlast/govuk-frontend/pull/2694).
...
This was added in [pull request 2727: Make use of hidden in header navigation functionality](https://github.com/CautionYourBlast/govuk-frontend/pull/2727). Thanks to @NickColley and @kr8n3r for their contributions.

### Fixes

In [pull request 2678: Replace ex units with ems for input lengths](https://github.com/CautionYourBlast/govuk-frontend/pull/2678), we changed how we define input lengths in our CSS. Browsers might now display these inputs as being slightly wider than before. The difference is usually fewer than 3 pixels.

We’ve also made fixes in the following pull requests:

- [#2668: Fix Summary List action link alignment](https://github.com/CautionYourBlast/govuk-frontend/pull/2668)
- [#2670: Define minimum width for select component](https://github.com/CautionYourBlast/govuk-frontend/pull/2670) - thanks @Nosfistis for reporting this issue
- [#2723: Style accordion and tabs text content with govuk-body class](https://github.com/CautionYourBlast/govuk-frontend/pull/2723)
- [#2724: Remove redundant aria-hidden attribute from the content when using the Details polyfill](https://github.com/CautionYourBlast/govuk-frontend/pull/2724)
- [#2725: Remove padding-right from last column in summary list row](https://github.com/CautionYourBlast/govuk-frontend/pull/2725) - thanks @edwardhorsford for reporting this issue and suggesting a fix
- [#2737: Avoid unnecessary spacing-related media queries](https://github.com/CautionYourBlast/govuk-frontend/pull/2737)
- [#2747: Ensure accordion uses overriden focus colour](https://github.com/CautionYourBlast/govuk-frontend/pull/2747) - thanks @NickColley for reporting this issue and suggesting a fix
...
This was added in [pull request #2610: Add pagination component](https://github.com/CautionYourBlast/govuk-frontend/pull/2610).
...
This change was introduced in [pull request #2616: Allow selecting options by passing current values](https://github.com/CautionYourBlast/govuk-frontend/pull/2616).
...
This change was introduced in [pull request #2617: Do not make the service name in the header a link if no `serviceUrl` is provided](https://github.com/CautionYourBlast/govuk-frontend/pull/2617).
...
This change was introduced in [pull request #2658: Add missing mandatory file extensions for ESM JavaScript](https://github.com/CautionYourBlast/govuk-frontend/pull/2658). Thanks to @colinrotherham and @tvararu for reporting issues and suggesting and testing fixes.

### Fixes

We’ve made fixes to GOV.UK Frontend in the following pull requests:

- [#2617: Do not make the service name in the header a link if no `serviceUrl` is provided](https://github.com/CautionYourBlast/govuk-frontend/pull/2617)
- [#2640: Add top padding to accordion section](https://github.com/CautionYourBlast/govuk-frontend/pull/2640)
- [#2644: Allow users to use `require.resolve` to import GOV.UK Frontend JavaScript](https://github.com/CautionYourBlast/govuk-frontend/pull/2644) - thanks to @HughePaul for reporting this issue and testing the fix
- [#2647: Allow users to import sass files via Webpack `sass-loader`](https://github.com/CautionYourBlast/govuk-frontend/pull/2647) - thanks to @Garethp for reporting this issue, and to @Garethp and @richpjames for testing the fix
- [#2659: Add missing label and legend classes to HTML fixtures](https://github.com/CautionYourBlast/govuk-frontend/pull/2659)
...
This was added in [pull request #2586: Publish our JavaScript as ES modules alongside Universal Module Definition (UMD)](https://github.com/CautionYourBlast/govuk-frontend/pull/2586).
...
This change was introduced in [pull request #2577: Refactor character count to inject new element](https://github.com/CautionYourBlast/govuk-frontend/pull/2577).
...
This change was introduced in [pull request #2599: Remove `pattern` attribute from date input component](https://github.com/CautionYourBlast/govuk-frontend/pull/2599).

### Fixes

We've made the following fixes in [pull request #2577: Refactor character count to inject new element](https://github.com/CautionYourBlast/govuk-frontend/pull/2577):
...
- [#2549: Fix header with product name focus and hover state length](https://github.com/CautionYourBlast/govuk-frontend/pull/2549)
- [#2573: Better handle cases where `$govuk-text-colour` is set to a non-colour value](https://github.com/CautionYourBlast/govuk-frontend/pull/2573)
- [#2590: Remove `maxlength` attribute from `textarea` after character count JavaScript has been initialised](https://github.com/CautionYourBlast/govuk-frontend/pull/2590)
- [#2615: Fix hints for disabled checkboxes or radios appearing darker than the associated labels](https://github.com/CautionYourBlast/govuk-frontend/pull/2615)
...
This change was introduced in [pull request #2491: Prevent error summary from being refocused after it has been initially focused on page load](https://github.com/CautionYourBlast/govuk-frontend/pull/2491).

### Fixes

We’ve made fixes to GOV.UK Frontend in the following pull requests:

- [#2475: Tweak whitespace HTML for text input component to improve readability](https://github.com/CautionYourBlast/govuk-frontend/pull/2475)
- [#2494: Allow disabling autofocus on error summary](https://github.com/CautionYourBlast/govuk-frontend/pull/2494)
- [#2514: Fix accordion heading style while JavaScript is disabled](https://github.com/CautionYourBlast/govuk-frontend/pull/2514)
- [#2515: Add explicit width to summary list row with 'no actions' pseudo-element](https://github.com/CautionYourBlast/govuk-frontend/pull/2515)
- [#2524: Fix select component renders with grey background in Firefox and Safari](https://github.com/CautionYourBlast/govuk-frontend/pull/2524)
...
This change was introduced in [pull request #2257: Update accordion design](https://github.com/CautionYourBlast/govuk-frontend/pull/2257).
...
This change was introduced in [pull request #2323: Avoid invalid nesting of `<span>` within a `<dd>` in summary list](https://github.com/CautionYourBlast/govuk-frontend/pull/2323). Thanks to [Malcolm Hire](https://github.com/malcolmhire) for reporting this issue.
...
This change was introduced in [pull request #2427: Improve the screen reader experience for the header menu](https://github.com/CautionYourBlast/govuk-frontend/pull/2427).
...
This change was introduced in [pull request #2432: Remove default font styles from cookie banner Sass](https://github.com/CautionYourBlast/govuk-frontend/pull/2432).

#### Update the HTML for hints

In GOV.UK Frontend v3.8.0, we [updated the HTML for hints to use a `<div>` rather than a `<span>` element, to allow the use of block elements](https://github.com/CautionYourBlast/govuk-frontend/issues/1835). We've now removed the styles which made the hint `<span>` display as block.
...
This change was introduced in [pull request #2437: Remove `display:block` on hint component](https://github.com/CautionYourBlast/govuk-frontend/pull/2437).
...
This change was introduced in [pull request #2450: Set focus to skip link target to improve screen reader announcements](https://github.com/CautionYourBlast/govuk-frontend/pull/2450).
...
This change was introduced in [pull request #2452: Update error messages to use paragraph tags instead of spans](https://github.com/CautionYourBlast/govuk-frontend/pull/2452).
...
This change was introduced in [pull request #2370: Prevent issues with conditionally revealed content when content `id` includes CSS syntax characters](https://github.com/CautionYourBlast/govuk-frontend/pull/2370).
...
This change was introduced in [pull request #2408: Prevent issues with character count when textarea `id` includes CSS syntax characters](https://github.com/CautionYourBlast/govuk-frontend/pull/2408).
...
This change was introduced in [pull request #2426: Rename exported JavaScript modules to include component name](https://github.com/CautionYourBlast/govuk-frontend/pull/2426). Thanks to [Alex Jurubita](https://github.com/alex-ju) for reporting this issue.
...
This change was introduced in [pull request #2455: Remove 'base' import from files in `core` and `overrides` layers](https://github.com/CautionYourBlast/govuk-frontend/pull/2455).
...
This change was introduced in [pull request #2463: Move template styles from `core` to `objects` layer](https://github.com/CautionYourBlast/govuk-frontend/pull/2463).
...
This change was introduced in [pull request #2462: Fix footer alignment with grid classes and add `width` macro option](https://github.com/CautionYourBlast/govuk-frontend/pull/2462).

#### Remove deprecated `$govuk-border-width-form-element-error` variable

In [GOV.UK Frontend v3.8.0](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v3.8.0), we made the border width of form elements in their error state the same as for form elements in their normal state and deprecated the `$govuk-border-width-form-element-error` variable.
...
This change was introduced in [pull request #1963: Remove deprecated `$govuk-border-width-form-element-error` variable](https://github.com/CautionYourBlast/govuk-frontend/pull/1963).

#### Remove deprecated `govuk-main-wrapper` and `govuk-main-wrapper--l` mixins

We've removed the `govuk-main-wrapper` and `govuk-main-wrapper--l` mixins we deprecated in [GOV.UK Frontend v3.0.0](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v3.0.0).
...
This change was introduced in [pull request #2385: Remove deprecated `govuk-main-wrapper` and `govuk-main-wrapper--l` mixins](https://github.com/CautionYourBlast/govuk-frontend/pull/2385).

#### Remove calls to deprecated `iff` Sass function

We've removed the `iff` function we deprecated in [GOV.UK Frontend version 3.6.0](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v3.6.0).
...
This change was introduced in [pull request #2409: Remove deprecated `iff` Sass function](https://github.com/CautionYourBlast/govuk-frontend/pull/2409).

#### Remove deprecated `govuk-tag--inactive` class

We've removed the `govuk-tag--inactive` class we deprecated in [GOV.UK Frontend v3.6.0](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v3.6.0).

Replace any use of this class with the `govuk-tag--grey` class.

This change was introduced in [pull request #2417: Remove deprecated `govuk-tag--inactive class`](https://github.com/CautionYourBlast/govuk-frontend/pull/2417).
...
There are some known issues with inputs of `type="number"`. [Read our research into the issues with `type="number"`.](https://github.com/CautionYourBlast/govuk-frontend/issues/1449#issuecomment-503186819)
...
This change was introduced in [pull request #1704: Update date input to use `type=text` and `inputmode=numeric`](https://github.com/CautionYourBlast/govuk-frontend/pull/1704).
...
This change was introduced in [pull request #1724: Fix fallback logo so Chrome will not flag it to screen readers](https://github.com/CautionYourBlast/govuk-frontend/pull/1724).
...
This change was introduced in [pull request #2192: Add `data-nosnippet` to prevent cookie banner text appearing in Google Search snippets](https://github.com/CautionYourBlast/govuk-frontend/pull/2192).

### Fixes

We’ve made fixes to GOV.UK Frontend in the following pull requests:

- [#2255: Prevent conditionally revealed questions getting out of sync when multiple sets of radios and checkboxes contain inputs with the same name](https://github.com/CautionYourBlast/govuk-frontend/pull/2255)
- [#2323: Avoid invalid nesting of `<span>` within a `<dd>` in summary list](https://github.com/CautionYourBlast/govuk-frontend/pull/2323)
- [#2370: Prevent issues with conditionally revealed content when content `id` includes CSS syntax characters](https://github.com/CautionYourBlast/govuk-frontend/pull/2370)
- [#2408: Prevent issues with character count when textarea `id` includes CSS syntax characters](https://github.com/CautionYourBlast/govuk-frontend/pull/2408)
- [#2426: Rename exported JavaScript modules to include component name](https://github.com/CautionYourBlast/govuk-frontend/pull/2426)
- [#2434: Add brand colour for Department for Levelling Up, Housing and Communities (DLUHC)](https://github.com/CautionYourBlast/govuk-frontend/pull/2434) - thanks to [Bruce Bolt](https://github.com/brucebolt) for contributing this change
- [#2447: Remove bottom margin from navigation on tablets](https://github.com/CautionYourBlast/govuk-frontend/pull/2447)
- [#2448: Remove the border from the last item in the collapsible navigation menu in the header](https://github.com/CautionYourBlast/govuk-frontend/pull/2448)
...
This was added in [pull request #2339: Add `text-align` override classes](https://github.com/CautionYourBlast/govuk-frontend/pull/2339). Thanks to [Ed Horsford](https://github.com/edwardhorsford) for reporting this issue.
...
This was added in [pull request #2348: Allow `govuk-spacing` to output negative spacing](https://github.com/CautionYourBlast/govuk-frontend/pull/2348). Thanks to [Chris Hill-Scott](https://github.com/quis) for reporting this issue.

### Fixes

- [#2347: Prevent panel text overflowing when zoomed in on mobile](https://github.com/CautionYourBlast/govuk-frontend/pull/2347) - thanks to [Phil Sherry](https://github.com/philsherry) for reporting this issue.
...
- [#2264: Improve focus state for radio and checkbox controls in forced colors mode (for example, Windows High Contrast Mode)](https://github.com/CautionYourBlast/govuk-frontend/pull/2264) – thanks to [@adamliptrot-oc](https://github.com/adamliptrot-oc) for reporting this issue
- [#2265: Do not remove focus outline from disabled link buttons in forced colors mode](https://github.com/CautionYourBlast/govuk-frontend/pull/2265)
- [#2273: Fix invisible footer on Open Government Licence logo in forced colors mode](https://github.com/CautionYourBlast/govuk-frontend/pull/2273) – thanks to [@oscarduignan](https://github.com/oscarduignan) for reporting this issue
- [#2277: Fix invisible start button chevron in forced colors mode](https://github.com/CautionYourBlast/govuk-frontend/pull/2277)
- [#2290: Improve support for Internet Explorer 11 with Windows High Contrast Mode](https://github.com/CautionYourBlast/govuk-frontend/pull/2290)
- [#2306: Add `max-width` to file upload component](https://github.com/CautionYourBlast/govuk-frontend/pull/2306)
- [#2312: Remove `padding-right` from details component](https://github.com/CautionYourBlast/govuk-frontend/pull/2312)
...
This was added in [pull request #2151: Add 'None of the above' and 'or' divider to checkboxes](https://github.com/CautionYourBlast/govuk-frontend/pull/2151). Thanks to [@frankieroberto](https://github.com/frankieroberto) for contributing this improvement.
...
This was added in [pull request #2245: Allow the CSP `nonce` attribute to be set on the inline script in the page template](https://github.com/CautionYourBlast/govuk-frontend/pull/2245). Thanks to [@natcarey](https://github.com/natcarey) for contributing this issue and its solution.

### Fixes

We've made the following fixes in [pull request #2229: Change approach to fallback PNG in the header to fix blank data URI from triggering Content Security Policy error](https://github.com/CautionYourBlast/govuk-frontend/pull/2229):
...
- [#2228: Fix display of checkboxes in Internet Explorer 8](https://github.com/CautionYourBlast/govuk-frontend/pull/2228)
- [#2237: Fix GOV.UK logo disappearing on light background in Windows High Contrast Mode](https://github.com/CautionYourBlast/govuk-frontend/pull/2237)
- [#2251: Disable ink skipping for underlines in hover state](https://github.com/CautionYourBlast/govuk-frontend/pull/2251)
...
- want to avoid opting in if you have links within a [multiple-column layout](https://developer.mozilla.org/en-US/docs/Learn/CSS/CSS_layout/Multiple-column_Layout) in your CSS - there is [a Chromium bug that affects such links](https://github.com/CautionYourBlast/govuk-frontend/issues/2204)
...
This was added in [pull request #2183: Updates to link styles and link hover states](https://github.com/CautionYourBlast/govuk-frontend/pull/2183).
...
This was added in [pull request #2214: Add no-underline mixin and modifier class](https://github.com/CautionYourBlast/govuk-frontend/pull/2214).
...
This was added in [pull request #2213: Add inverse link mixin and modifier class](https://github.com/CautionYourBlast/govuk-frontend/pull/2213).
...
This was added in [pull request #2164: Enable cookie banner to set link styled as a button](https://github.com/CautionYourBlast/govuk-frontend/pull/2164).

### Fixes

- [#2132: Improve vertical alignment of phase banner tag on mobile devices](https://github.com/CautionYourBlast/govuk-frontend/pull/2132) – thanks to [@matthewmascord](https://github.com/matthewmascord) for contributing this issue.
- [#2157: Use pointer cursor for 'Menu' button in header](https://github.com/CautionYourBlast/govuk-frontend/pull/2157) – thanks to [@MalcolmVonMoJ](https://github.com/MalcolmVonMoJ) for contributing this issue.
- [#2171: Fix padding on GOV.UK logo affecting hover and focus states](https://github.com/CautionYourBlast/govuk-frontend/pull/2171)
- [#2186: Fix display of warning text in Edge when Windows High Contrast Mode is enabled](https://github.com/CautionYourBlast/govuk-frontend/pull/2186)
- [#2192: Add data-nosnippet to prevent cookie banner text appearing in Google Search snippets](https://github.com/CautionYourBlast/govuk-frontend/pull/2192)
- [#2201: Set -webkit-appearance: button on file upload so text is aligned in Safari](https://github.com/CautionYourBlast/govuk-frontend/pull/2201)
- [#2205: Stop file upload component 'jumping' on focus](https://github.com/CautionYourBlast/govuk-frontend/pull/2205)
- [#2212: Add underline to crown copyright link in footer](https://github.com/CautionYourBlast/govuk-frontend/pull/2212)
...
This was added in [pull request #2131: Add cookie banner component and button groups](https://github.com/CautionYourBlast/govuk-frontend/pull/2131).
...
This was added in [pull request #2114: Add button groups for use in cookie banner](https://github.com/CautionYourBlast/govuk-frontend/pull/2114).
...
This was added in [pull request #2048: Add modifiers for table captions](https://github.com/CautionYourBlast/govuk-frontend/pull/2048).

### Fixes

We’ve made fixes to GOV.UK Frontend in the following pull requests:

- [#2045: Stop same-site cookies from being wiped when printing in Internet Explorer 11](https://github.com/CautionYourBlast/govuk-frontend/pull/2045) – thanks to [@gunjam](https://github.com/gunjam) for contributing this issue.
- [#2080: Fix JavaScript error when character count ID starts with a number](https://github.com/CautionYourBlast/govuk-frontend/pull/2080) - thanks to [@josef-vlach](https://github.com/josef-vlach) for reporting this issue.
- [#2092: Use tabular numbers for character count message](https://github.com/CautionYourBlast/govuk-frontend/pull/2092) - thanks to [@quis](https://github.com/quis) for contributing this issue.
- [#2093: Only output space after breadcrumbs class if there’s an additional class](https://github.com/CautionYourBlast/govuk-frontend/pull/2093) – thanks to [@frankieroberto](https://github.com/frankieroberto) for contributing this issue.
- [#2133: Remove user-agent default 2px horizontal margins on buttons in Safari](https://github.com/CautionYourBlast/govuk-frontend/pull/2133)
...
- [#2031: Include hidden status of the component examples in published fixtures](https://github.com/CautionYourBlast/govuk-frontend/pull/2031) – thanks to [@andymantell](https://github.com/andymantell) for contributing this
- [#2043: Fixes for a couple of component examples / fixtures](https://github.com/CautionYourBlast/govuk-frontend/pull/2043) – thanks to [@andymantell](https://github.com/andymantell) for contributing this as well!
- [#2071: Use non-bool type strings for attributes in test fixtures](https://github.com/CautionYourBlast/govuk-frontend/pull/2071) – thanks to [@matthew-shaw](https://github.com/matthew-shaw) for contributing this
...
- [#2035: Fix hairline gap between notification banner header and outer border on high resolution screens in Chrome/Edge (Blink)](https://github.com/CautionYourBlast/govuk-frontend/pull/2035)
- [#2036: Explicitly set the text colour for notification banner content, rather than using the user-agent default text colour](https://github.com/CautionYourBlast/govuk-frontend/pull/2036)
- [#2042: Wrap notification banner content at 2/3 grid width](https://github.com/CautionYourBlast/govuk-frontend/pull/2042)
...
This was added in [pull request #1935: Create notification banner component](https://github.com/CautionYourBlast/govuk-frontend/issues/1935).
...
This was added in [pull request #1975: Enable custom inputmode for date input component](https://github.com/CautionYourBlast/govuk-frontend/pull/1975). Thanks to [@foaly-nr1](https://github.com/foaly-nr1) for contributing this issue.
...
- [#1967: Fix navigation links in the header not being announced by screen readers](https://github.com/CautionYourBlast/govuk-frontend/pull/1967)
...
This was added in [pull request #1816: Add input prefix and suffix](https://github.com/CautionYourBlast/govuk-frontend/pull/1816). Thanks to [@simonwhatley](https://github.com/simonwhatley) and the GOV.UK Coronavirus Services Team.
...
This was added in [pull request #1925: Generate fixtures.json files for components on build:package](https://github.com/CautionYourBlast/govuk-frontend/pull/1925). Thanks to everyone who fed back on [our test fixtures proposal](https://github.com/CautionYourBlast/govuk-frontend/issues/1830#issuecomment-665075842).
...
- [#1905: Set navigation and mobile menu labels of the header component with new options](https://github.com/CautionYourBlast/govuk-frontend/pull/1905)
- [#1943: Change header menu button label](https://github.com/CautionYourBlast/govuk-frontend/pull/1943) - thanks to [@domoscargin](https://github.com/domoscargin) for raising this issue
...
This was added in [pull request #1921: Make it possible to exclude link from header navigation item](https://github.com/CautionYourBlast/govuk-frontend/pull/1921).

### Fixes

We’ve made fixes to GOV.UK Frontend in the following pull requests:

- [#1918: Add new brand colour for FCDO](https://github.com/CautionYourBlast/govuk-frontend/pull/1918) - thanks to [@deborahchua](https://github.com/deborahchua) and [@beccapearce](https://github.com/beccapearce) for contributing this
- [#1942: Set aria-expanded and aria-hidden attributes on header menu button and menu when page loads](https://github.com/CautionYourBlast/govuk-frontend/pull/1942)
- [#1947 Add print styles for the panel component](https://github.com/CautionYourBlast/govuk-frontend/pull/1947)
...
- [#1912: Fix character count shrinking as you go over limit](https://github.com/CautionYourBlast/govuk-frontend/pull/1912)
...
This was added in [pull request #1827: Make dark grey darker](https://github.com/CautionYourBlast/govuk-frontend/pull/1827).
...
This was added in [pull request #1870: Reduce border width of form inputs in the error state](https://github.com/CautionYourBlast/govuk-frontend/pull/1870).
...
- [#1859: Add spellcheck option](https://github.com/CautionYourBlast/govuk-frontend/pull/1859)
- [#1869: Add missing spellcheck param to character count](https://github.com/CautionYourBlast/govuk-frontend/pull/1869)
...
This was changed in [pull request #1870: Reduce border width of form inputs in the error state](https://github.com/CautionYourBlast/govuk-frontend/pull/1870).

### Fixes

We’ve made fixes to GOV.UK Frontend in the following pull requests:

- [#1838: Correctly camel case SVG attributes in the header and footer](https://github.com/CautionYourBlast/govuk-frontend/pull/1838)
- [#1842: Preserve the state of conditional reveals when navigating 'back' in the browser](https://github.com/CautionYourBlast/govuk-frontend/pull/1842)
- [#1848: Preserve the state of the character count when navigating 'back' in the browser](https://github.com/CautionYourBlast/govuk-frontend/pull/1848)
- [#1855: Hint component can render block-level elements as valid HTML](https://github.com/CautionYourBlast/govuk-frontend/pull/1855)
- [#1861: Fix the display of checkboxes when border-box box sizing is applied globally](https://github.com/CautionYourBlast/govuk-frontend/pull/1861)
- [#1862: Fix display of warning text icon when border-box box sizing is applied globally #1862](https://github.com/CautionYourBlast/govuk-frontend/pull/1862)
- [#1879: Explicitly set outline-offset to remove 1px transparent border in chrome v84](https://github.com/CautionYourBlast/govuk-frontend/pull/1879)
...
This was added in [pull request #1775: Add list--spaced modifier](https://github.com/CautionYourBlast/govuk-frontend/pull/1775). Thanks to [@frankieroberto](https://github.com/frankieroberto) for raising this issue.
...
This was added in [pull request #1819: Add the ability to specify HTML for a navigation item](https://github.com/CautionYourBlast/govuk-frontend/pull/1819). Thanks to [@adamsilver](https://github.com/adamsilver).
...
This was added in [pull request #1804: Allow components to be imported without dependencies](https://github.com/CautionYourBlast/govuk-frontend/pull/1804). Thanks to [@kevindew](https://github.com/kevindew) for raising this issue.
...
This was added in [pull request #1754: Add collapseOnMobile breadcrumbs flag](https://github.com/CautionYourBlast/govuk-frontend/pull/1754). Thanks to [@vanitabarrett](https://github.com/vanitabarrett) and [@miaallers](https://github.com/miaallers).
...
This was added in [pull request #1753: Make back link arrow consistent with breadcrumb component](https://github.com/CautionYourBlast/govuk-frontend/pull/1753). Thanks to [@vanitabarrett](https://github.com/vanitabarrett) and [@miaallers](https://github.com/miaallers).
...
This was added in [pull request #1807: Warn if importing core, overrides without dependencies](https://github.com/CautionYourBlast/govuk-frontend/pull/1807).

### Fixes

We’ve made fixes to GOV.UK Frontend in the following pull requests:

- [#1778: Fix accordion underline hover state being removed when hovering plus/minus symbol](https://github.com/CautionYourBlast/govuk-frontend/pull/1778)
- [#1765: Import textarea from character count](https://github.com/CautionYourBlast/govuk-frontend/pull/1765)
- [#1796: Standardise accordion section headings font size (reduce height of section headings on mobile)](https://github.com/CautionYourBlast/govuk-frontend/pull/1796)
...
[Pull request #1711: Additional Tag modifier classes for different colours](https://github.com/CautionYourBlast/govuk-frontend/pull/1711).
...
[Pull request #1723: Add display override for hiding content when printing](https://github.com/CautionYourBlast/govuk-frontend/pull/1723).
...
[Pull request #1742: Deprecate iff function](https://github.com/CautionYourBlast/govuk-frontend/pull/1742).

### Fixes

- [Pull request #1724: Fix fallback logo being detected by Google Chrome's image description feature](https://github.com/CautionYourBlast/govuk-frontend/pull/1724).
- [Pull request #1745: Update vendor polyfills to match upstream](https://github.com/CautionYourBlast/govuk-frontend/pull/1745).
- [Pull request #1746: Use generic div element for tabspanel](https://github.com/CautionYourBlast/govuk-frontend/pull/1746).
...
- [Pull request #1650: Make Character Count use hint component for message and allow custom classes to be added](https://github.com/CautionYourBlast/govuk-frontend/pull/1650).

### Fixes

- [Pull request #1704: Update the date input component to use `input type=text inputmode=numeric`](https://github.com/CautionYourBlast/govuk-frontend/pull/1704).
- [Pull request #1690: Don't unneccesarily self-close tags](https://github.com/CautionYourBlast/govuk-frontend/pull/1690).
- [Pull request #1678: Fix tabs component throwing JavaScript errors in Internet Explorer 8](https://github.com/CautionYourBlast/govuk-frontend/pull/1678).
- [Pull request #1676: Fix skip link component focus style with global styles enabled](https://github.com/CautionYourBlast/govuk-frontend/pull/1676).
- [Pull request #1672: Ensure footer links look clickable](https://github.com/CautionYourBlast/govuk-frontend/pull/1672).
- [Pull request #1670: Make width-container margins more targetted to avoid specificity issues](https://github.com/CautionYourBlast/govuk-frontend/pull/1670).
- [Pull request #1655: Ensure components use public `govuk-media-query` mixin](https://github.com/CautionYourBlast/govuk-frontend/pull/1655).
- [Pull request #1648: Update checkboxes and radio buttons to include item hint classes on item hint](https://github.com/CautionYourBlast/govuk-frontend/pull/1648).
- [Pull request #1638: Check component item arrays are not empty before outputting markup](https://github.com/CautionYourBlast/govuk-frontend/pull/1638).
...
[Pull request #1626: Allow creating custom width containers and using them with template](https://github.com/CautionYourBlast/govuk-frontend/pull/1626).
...
- [Pull request #1623: Allow attributes to be set on template <body>](https://github.com/CautionYourBlast/govuk-frontend/pull/1623).

### Fixes

- [Pull request #1594: Refactor handling of count message in character count JavaScript](https://github.com/CautionYourBlast/govuk-frontend/pull/1594).
- [Pull request #1609: Update hex value for secondary text to improve contrast](https://github.com/CautionYourBlast/govuk-frontend/pull/1609).
- [Pull request #1620: Only add underline to back link when href exists](https://github.com/CautionYourBlast/govuk-frontend/pull/1620).
- [Pull request #1631: Fix classes on character count when in error state](https://github.com/CautionYourBlast/govuk-frontend/pull/1631).
...
- [Pull request #1576: Allow `lang` to be set on title and main of template](https://github.com/CautionYourBlast/govuk-frontend/pull/1576).

#### Add new override class to hide elements

You can now use the `.govuk-!-display-none` override class to hide elements.

- [Pull request #1586: Add display none override class](https://github.com/CautionYourBlast/govuk-frontend/pull/1586).

#### Visual updates to the warning text component

Align ‘Warning text’ icon with first line of the content fixing [#1352](https://github.com/CautionYourBlast/govuk-frontend/issues/1352) Some changes were made to the size and spacing of the icon to help with positioning.

- [Pull request #1578: Change position and spacing relationship of warning text icon](https://github.com/CautionYourBlast/govuk-frontend/pull/1578)

### Fixes

- [Pull request #1574: Make form elements scale correctly when text resized by user](https://github.com/CautionYourBlast/govuk-frontend/pull/1574).
- [Pull request #1584: Fix text resize issue with warning text icon](https://github.com/CautionYourBlast/govuk-frontend/pull/1584)
- [Pull request #1570: Prevent inputs ending up off screen or obscured by keyboards when linking from the error summary to inputs within a large fieldset](https://github.com/CautionYourBlast/govuk-frontend/pull/1570)
- [Pull request #1585: Explicitly set font weight on warning-text component](https://github.com/CautionYourBlast/govuk-frontend/pull/1585)
- [Pull request #1587: Fix height and alignment issue within header in Chrome 76+](https://github.com/CautionYourBlast/govuk-frontend/pull/1587)
- [Pull request #1589: Remove role="button" from header button](https://github.com/CautionYourBlast/govuk-frontend/pull/1589)
- [Pull request #1595: Do not output conditionally revealed content for radios or checkboxes when it's empty](https://github.com/CautionYourBlast/govuk-frontend/pull/1595)
...
- [Pull request #1553: Include formGroup on character count and pass through to textarea to allow class to be added to character count form group](https://github.com/CautionYourBlast/govuk-frontend/pull/1553). Thanks to [Emma Lewis](https://github.com/LBHELewis).

### Fixes

- [Pull request #1548: Fix fieldset legend text clipping when using a custom or fallback font](https://github.com/CautionYourBlast/govuk-frontend/pull/1548).
- [Pull request #1559: Stop IE8 from downloading GDS Transport font](https://github.com/CautionYourBlast/govuk-frontend/pull/1559).
- [Pull request #1564: Ensure legacy styles do not override button active state](https://github.com/CautionYourBlast/govuk-frontend/pull/1564).
...
[Pull request #1541: Allow date input fieldset attributes to be set](https://github.com/CautionYourBlast/govuk-frontend/pull/1541). Thanks to [andrew-mcgregor](https://github.com/andrew-mcgregor) for raising this.

#### Add ARIA role to the fieldset component

You can now pass an ARIA role to the fieldset component.

[Pull request #1541: Allow date input fieldset attributes to be set](https://github.com/CautionYourBlast/govuk-frontend/pull/1541).
...
- [Pull request #1527: Add inputmode option to the input component](https://github.com/CautionYourBlast/govuk-frontend/pull/1527)

### Fixes

- [Pull request #1523: Improve accessibility of details component by polyfilling only where the native element is not available](https://github.com/CautionYourBlast/govuk-frontend/pull/1523).
- [Pull request #1512: Update components to only output items when they are defined](https://github.com/CautionYourBlast/govuk-frontend/pull/1512).
- [Pull request #1538: Simplify button types to avoid unnecessary type attribute](https://github.com/CautionYourBlast/govuk-frontend/pull/1538).
- [Pull request #1542: Only default two thirds/one-third layout when footer has two sections](https://github.com/CautionYourBlast/govuk-frontend/pull/1542).
...
If you’ve [added `node_modules/govuk-frontend` as a Sass include path](https://github.com/CautionYourBlast/govuk-frontend/blob/master/docs/installation/installing-with-npm.md#optional-resolving-scss-import-paths), add `govuk/` to your `@import` paths:
...
You do not need to do anything if you're using Nunjucks macros and the [`initAll`](https://github.com/CautionYourBlast/govuk-frontend/blob/master/docs/installation/installing-with-npm.md#option-1-include-javascript) function.
...
[Pull request #1443: Ensure GOV.UK Frontend component selectors cannot conflict when initialised](https://github.com/CautionYourBlast/govuk-frontend/pull/1443)
...
[Pull request #1444: Renames `js-` css prefix to `govuk-js-`](https://github.com/CautionYourBlast/govuk-frontend/pull/1444)
...
- [#1458: Namespace nunjucks and components](https://github.com/CautionYourBlast/govuk-frontend/pull/1458)
- [#1467: Update the main entry point in package.json](https://github.com/CautionYourBlast/govuk-frontend/pull/1467)
...
- [#1309: Update links (and things that look like links) to use the new focus style](https://github.com/CautionYourBlast/govuk-frontend/pull/1309)
- [#1312: Update form inputs focus to comply with WCAG 2.1](https://github.com/CautionYourBlast/govuk-frontend/pull/1312)
- [#1313: Add new focus style to buttons](https://github.com/CautionYourBlast/govuk-frontend/pull/1315)
- [#1321: Update footer links to use new focus style](https://github.com/CautionYourBlast/govuk-frontend/pull/1321)
- [#1324: Update accordion to use new WCAG 2.1 compliant focus style](https://github.com/CautionYourBlast/govuk-frontend/pull/1324)
- [#1326: Update tabs component to WCAG 2.1 compliant focus style](https://github.com/CautionYourBlast/govuk-frontend/pull/1326)
- [#1361: Remove `govuk-focusable`, `govuk-focusable-fill` mixins, introduce `govuk-focus-text` mixin](https://github.com/CautionYourBlast/govuk-frontend/pull/1361)
...
If you're using legacy projects like GOV.UK Elements, you can keep your current colours by [turning on compatibility mode](https://github.com/CautionYourBlast/govuk-frontend/blob/master/docs/installation/compatibility.md).
...
[Pull request #1288: Update colour palette](https://github.com/CautionYourBlast/govuk-frontend/pull/1288).
...
If you're using GOV.UK Frontend and [GOV.UK Template](https://github.com/alphagov/govuk_template), you can [turn on compatibility mode](https://github.com/CautionYourBlast/govuk-frontend/blob/master/docs/installation/compatibility.md) to keep using the font from GOV.UK Template.

Pull requests:

- [#1434: Update font to use v2 of GOV.UK Transport font](https://github.com/CautionYourBlast/govuk-frontend/pull/1434)
- [#1441: Removing font style adjustments](https://github.com/CautionYourBlast/govuk-frontend/pull/1441)
...
[Pull request #1426: Make radios and checkboxes components easier to link to from error summary](https://github.com/CautionYourBlast/govuk-frontend/pull/1426)
...
[Pull request #1496: Update the focus state for tabs](https://github.com/CautionYourBlast/govuk-frontend/pull/1443)
...
[Pull request #1341: Add new start button icon](https://github.com/CautionYourBlast/govuk-frontend/pull/1341)
...
[Pull request #1345: Set 'vertical-align:top' positioning on table headers and cells](https://github.com/CautionYourBlast/govuk-frontend/pull/1345)
...
- [#1376: Remove $class param from @govuk-grid-column mixin](https://github.com/CautionYourBlast/govuk-frontend/pull/1376)
- [#1342: Remove grid-width mixin](https://github.com/CautionYourBlast/govuk-frontend/pull/1342)
- [#1343: Removes govuk-grid-row mixin](https://github.com/CautionYourBlast/govuk-frontend/pull/1343)
...
[Pull request #1287: Rename border-width-mobile to reflect how it's used](https://github.com/CautionYourBlast/govuk-frontend/pull/1287)
...
[Pull request #1367: Allow for classes, rowspan, colspan and attributes on row headers](https://github.com/CautionYourBlast/govuk-frontend/pull/1367). Thanks to [edwardhorsford](https://github.com/edwardhorsford).
...
[Pull request #1493: Add automatic vertical spacing modifier for main wrapper](https://github.com/CautionYourBlast/govuk-frontend/pull/1493)
...
[Pull request #1434: Update font to use v2 of GOV.UK Transport font](https://github.com/CautionYourBlast/govuk-frontend/pull/1434). Thanks to [@Nooshu](https://github.com/Nooshu).

### Fixes

- [Pull request #1310: The border on error summaries is now the correct width on mobile.
  GOV.UK Template's focused link colour no longer overrides GOV.UK Frontend](https://github.com/CautionYourBlast/govuk-frontend/pull/1310).
- [Pull request #1316: Checkboxes and radios no longer have a transparent outline - because it's no longer needed to fix custom focus state colours](https://github.com/CautionYourBlast/govuk-frontend/pull/1316).
- [Pull request #1324: There’s no longer an outline when a user focuses an accordion element in Firefox](https://github.com/CautionYourBlast/govuk-frontend/pull/1324).
- [Pull request #1330: We've changed the spacing around lists in tabs on mobile and with JavasScript disabled, so they're consistent with other lists](https://github.com/CautionYourBlast/govuk-frontend/pull/1330).
- [Pull request #1351: You can now use HTML elements in the labels for tabs](https://github.com/CautionYourBlast/govuk-frontend/pull/1351).
- [Pull request #1353: Example HTML code in the Design System now has correct indenting](https://github.com/CautionYourBlast/govuk-frontend/pull/1353).
- [Pull request #1368: We’ve clarified how you should use `productName` and `serviceName` in the header component](https://github.com/CautionYourBlast/govuk-frontend/pull/1368) - thanks to [@edwardhorsford](https://github.com/edwardhorsford).
- [Pull request #1359: Users can now use the Tab key to highlight tabs in IE8](https://github.com/CautionYourBlast/govuk-frontend/pull/1359).
- [Pull request #1370: Each submit button on a page now has its own double-click timer, so clicking one button will not disable the other buttons](https://github.com/CautionYourBlast/govuk-frontend/pull/1370).
- [Pull request #1381: You can now import the Sass settings files without needing to import the other settings first](https://github.com/CautionYourBlast/govuk-frontend/pull/1381).
- [Pull request #1442: Character count components are now hidden to assistive technologies when they're not visible](https://github.com/CautionYourBlast/govuk-frontend/pull/1442).
- [Pull request #1434: The underline below links no longer sits too far down in Firefox](https://github.com/CautionYourBlast/govuk-frontend/pull/1434).
- [Pull request #1435: When a user resubmits a form, the error summary is now correctly focused instead of the form](https://github.com/CautionYourBlast/govuk-frontend/pull/1435).
- [Pull request #1473: We’ve removed icon-arrow-left.png and icon-important.png, because they were not used in GOV.UK Frontend](https://github.com/CautionYourBlast/govuk-frontend/pull/1473)
- [Pull request #1497: Users can now conditionally reveal content on pages with multiple grouped radios](https://github.com/CautionYourBlast/govuk-frontend/pull/1497) - thanks to [@colinrotherham](https://github.com/colinrotherham) and [@frankieroberto](https://github.com/frankieroberto) for their help.
...
- You can now override the visually hidden 'Support links' text in the footer by
  ...
  ([Pull request #1387](https://github.com/CautionYourBlast/govuk-frontend/pull/1387))
...
- Secondary buttons and warning buttons now have the correct background colour
  ...
  ([Pull request #1392](https://github.com/CautionYourBlast/govuk-frontend/pull/1392))
...
- The crown logo image in the header now:
  ...
  ([Pull request #1419](https://github.com/CautionYourBlast/govuk-frontend/pull/1419))
...
- Support custom attributes on summary list action links
  ...
  ([PR #1372](https://github.com/CautionYourBlast/govuk-frontend/pull/1372))
...
- Support aria-describedby on all form fields
  ...
  ([PR #1347](https://github.com/CautionYourBlast/govuk-frontend/pull/1347))
...
- Update colour for MHCLG
  ...
  ([PR #1319](https://github.com/CautionYourBlast/govuk-frontend/pull/1319))

- Remove deprecated `@else-if` statement, replace with `@else if`

  ([PR #1333](https://github.com/CautionYourBlast/govuk-frontend/pull/1333))
...
- Prevent the fallback PNG image for the crown in the header from being
  ...
  ([PR #1337](https://github.com/CautionYourBlast/govuk-frontend/pull/1337))
...
- Add new secondary and warning button variants
  ...
  ([PR #1207](https://github.com/CautionYourBlast/govuk-frontend/pull/1207))
...
- Add support for custom row classes on the summary list component (including support for some rows without action links)
  ...
  ([PR #1259](https://github.com/CautionYourBlast/govuk-frontend/pull/1259))
...
- Ensure fieldset never exceeds max-width
  ...
  See discussion in ["Reset your fieldset"](https://thatemil.com/blog/2015/01/03/reset-your-fieldset/) and raised by [issue #1264](https://github.com/CautionYourBlast/govuk-frontend/issues/1264)

  ([PR #1269](https://github.com/CautionYourBlast/govuk-frontend/pull/1269))
...
- Add smaller versions of radio buttons and checkboxes
  ...
  ([PR #1125](https://github.com/CautionYourBlast/govuk-frontend/pull/1125))

🔧 Fixes:

- Prevent duplicate checkbox aria-describedby

  Addresses an edge case where a checkbox with a hint (but without a fieldset) is output with duplicate `aria-describeby` attributes. Fixes issue [#1248](https://github.com/CautionYourBlast/govuk-frontend/pull/1248).

  Thanks to [@colinrotherham](https://github.com/colinrotherham) for fixing this issue.

  ([PR #1265](https://github.com/CautionYourBlast/govuk-frontend/pull/1265))
...
- Add classes to action items in the summary list component
  ...
  ([PR #1233](https://github.com/CautionYourBlast/govuk-frontend/pull/1233))
...
- Allow initAll to be scoped to a specific part of a page
  ...
  ([PR #1216](https://github.com/CautionYourBlast/govuk-frontend/pull/1216))
...
- Fix tabs bullet point character encoding issue when not enhanced
  ...
  ([PR #1247](https://github.com/CautionYourBlast/govuk-frontend/pull/1247))
...
- Update padding of govuk-main-wrapper
  ...
  ([PR #1073](https://github.com/CautionYourBlast/govuk-frontend/pull/1073))

- Remove error-summary dependence on document.onload

  ([PR #1215](https://github.com/CautionYourBlast/govuk-frontend/pull/1215))
...
- Ensure font is not loaded twice on slow networks
  ...
  ([PR #1242](https://github.com/CautionYourBlast/govuk-frontend/pull/1242))

## 2.8.0 (Feature release)

### Considerations for fixed components such as modals

We have been made aware that the [change to force scroll bars to appear at all times](https://github.com/CautionYourBlast/govuk-frontend/pull/1230) can change the behaviour of some components such as modals.
...
- Enable `pattern` attribute for input
  ...
  ([PR #1172](https://github.com/CautionYourBlast/govuk-frontend/pull/1172))
...
- Prevent horizontal jump as scrollbars appear
  ...
  <https://github.com/CautionYourBlast/govuk-frontend/issues/1204>

  ([PR #1230](https://github.com/CautionYourBlast/govuk-frontend/pull/1230))
...
- Accommodate camera notches on new devices (iPhone X, Google Pixel 3 etc)
  ...
  ([PR #1176](https://github.com/CautionYourBlast/govuk-frontend/pull/1176))

- Prefix error messages with a visually hidden "Error:", to make it clearer to
  users of assistive technologies

  ([PR #1221](https://github.com/CautionYourBlast/govuk-frontend/pull/1221))
...
- Prevent accidental multiple submissions of forms
  ...
  ([PR #1018](https://github.com/CautionYourBlast/govuk-frontend/pull/1018))
...
- Ensure that files within the core, objects and overrides layers can be
  ...
  ([PR #1235](https://github.com/CautionYourBlast/govuk-frontend/pull/1235))
...
- Ensure inset component does not misalign nested components
  ...
  ([PR #1232](https://github.com/CautionYourBlast/govuk-frontend/pull/1232))
...
- Improve word wrapping in summary list component
  ...
  Also thanks to [Malcolm Butler](https://github.com/MoJ-Longbeard) for exploring a [previous version of this fix](https://github.com/CautionYourBlast/govuk-frontend/pull/1185).

  ([PR #1220](https://github.com/CautionYourBlast/govuk-frontend/pull/1220))
...
- Added config file for prototype kit.
  ...
  ([PR #1102](https://github.com/CautionYourBlast/govuk-frontend/pull/1102))
...
- Disable incorrect iOS/Edge text size adjustments
  ...
  ([PR #1178](https://github.com/CautionYourBlast/govuk-frontend/pull/1178))
...
- Fix wrapping of long lines of text in summary list
  ...
  ([PR #1169](https://github.com/CautionYourBlast/govuk-frontend/pull/1169))
...
- Enable `autocomplete` attributes for input components.
  ...
  ([PR #1146](https://github.com/CautionYourBlast/govuk-frontend/pull/1146))
...
- Include Accordion component in global namespace
  ...
  ([PR #1157](https://github.com/CautionYourBlast/govuk-frontend/pull/1157))
...
- Fix Checkboxes and Radios targeting selectors outside it's scope
  ...
  ([PR #1156](https://github.com/CautionYourBlast/govuk-frontend/pull/1156))

- Fixes styling of the accordion component when there is no JavaScript or it has been turned off

  Thanks @dankmitchell for reporting this issue ([#1130](https://github.com/CautionYourBlast/govuk-frontend/issues/1130))

  ([PR #1149](https://github.com/CautionYourBlast/govuk-frontend/pull/1149))

- Remove hover state for accordion sections on mobile

  ([PR #1148](https://github.com/CautionYourBlast/govuk-frontend/pull/1148))
...
- Fix container not being centered in IE8
  ...
  ([PR #1147](https://github.com/CautionYourBlast/govuk-frontend/pull/1147))
...
- Make gutters in the header consistent with the grid
  ...
  ([PR #1144](https://github.com/CautionYourBlast/govuk-frontend/pull/1144))
...
- Update summary list to simplify actions
  ...
  ([PR #1131](https://github.com/CautionYourBlast/govuk-frontend/pull/1131))
...
- Accordion component 🎉
  ...
  ([PR #958](https://github.com/CautionYourBlast/govuk-frontend/pull/958))
...
- Add desktop specific grid column widths
  ...
  ([PR #1094](https://github.com/CautionYourBlast/govuk-frontend/pull/1094))
...
- Add summary list component
  ...
  ([PR #1065](https://github.com/CautionYourBlast/govuk-frontend/pull/1065))
...
- Update visually hidden class to fix ordering issue in VoiceOver OSX
  ...
  ([PR #1109](https://github.com/CautionYourBlast/govuk-frontend/pull/1109))
...
- Improve rendering in older Internet Explorer
  ...
  ([PR #1119](https://github.com/CautionYourBlast/govuk-frontend/pull/1119))
...
- Remove unused hint, error message and label imports from the Character Count
  ...
  ([PR #1087](https://github.com/CautionYourBlast/govuk-frontend/pull/1087))

- Warning text component, remove negative margin left and reduce padding left to match.

  ([PR #1084](https://github.com/CautionYourBlast/govuk-frontend/pull/1084))
...
- Add 5px bottom margin to list items within lists that do not have bullets or
  ...
  ([PR #1078](https://github.com/CautionYourBlast/govuk-frontend/pull/1078))

- Add error message attributes to all components

  ([PR #1086](https://github.com/CautionYourBlast/govuk-frontend/pull/1086))
...
- Scroll to label or legend when linked from error summary
  ...
  ([PR #1056](https://github.com/CautionYourBlast/govuk-frontend/pull/1056))
...
- Allow form group classes on date, file upload, input, select and textarea
  ...
  ([PR #1059](https://github.com/CautionYourBlast/govuk-frontend/pull/1059))

🔧 Fixes:

- Remove implicit dependency on Element for classList

  ([PR #1063](https://github.com/CautionYourBlast/govuk-frontend/pull/1063))
...
- Single field with error should have 'aria-describeby' attribute
  ...
  ([PR #1054](https://github.com/CautionYourBlast/govuk-frontend/pull/1054))
...
- Add important parameter to visually hidden sass mixins
  ...
  ([PR #1037](https://github.com/CautionYourBlast/govuk-frontend/pull/1037))
...
- Add support for attributes on table cells
  ...
  ([PR #1045](https://github.com/CautionYourBlast/govuk-frontend/pull/1045))
...
- Allow form group classes on radios and checkboxes
  ...
  ([PR #1043](https://github.com/CautionYourBlast/govuk-frontend/pull/1043))

🔧 Fixes:

- Fix anchor links in tabs component panels

  ([PR #1031](https://github.com/CautionYourBlast/govuk-frontend/pull/1031))

- Fix IE8 support in builds in the `dist/` folder

  ([PR #1035](https://github.com/CautionYourBlast/govuk-frontend/pull/1035))
...
- Allow classes on table header and row cells
  ...
  ([PR #1015](https://github.com/CautionYourBlast/govuk-frontend/pull/1015))

- Add character count component

  ([PR #959](https://github.com/CautionYourBlast/govuk-frontend/pull/959))
...
- Apply max-width to the `<select>` element
  ...
  ([PR #1013](https://github.com/CautionYourBlast/govuk-frontend/pull/1013))
...
- Prevent product name in header from wrapping
  ...
  ([PR #1007](https://github.com/CautionYourBlast/govuk-frontend/pull/1007))

- Set text colour for radios divider

  ([PR 1023](https://github.com/CautionYourBlast/govuk-frontend/pull/1023))
...
- Stop links styled as button from being dragged
  ...
  ([PR #1020](https://github.com/CautionYourBlast/govuk-frontend/pull/1020))
...
- Allow additional 'meta' content in the footer
  ...
  ([PR #990](https://github.com/CautionYourBlast/govuk-frontend/pull/990))
...
- Allow attributes to be added to some child items in header, footer, breadcrumbs, tabs and error-summary components
  ...
  ([PR #993](https://github.com/CautionYourBlast/govuk-frontend/pull/993))
...
- Fix issue with conditional form content and inline form controls
  ...
  ([PR #970](https://github.com/CautionYourBlast/govuk-frontend/pull/970))
...
- Add component options (arguments) as `macro-options.json` to `package`
  ...
  ([PR #998](https://github.com/CautionYourBlast/govuk-frontend/pull/998))
...
- Update `browsersList` in `package.json` to reflect our supported browsers
  ...
  ([PR #1002](https://github.com/CautionYourBlast/govuk-frontend/pull/1002))
...
- Set panel component's title heading level to 1 as default
  ...
  ([PR #967](https://github.com/CautionYourBlast/govuk-frontend/pull/967))
...
- Remove deprecated `govuk-visually-hidden-focussable` class name
  ...
  ([PR #968](https://github.com/CautionYourBlast/govuk-frontend/pull/968))

- Remove name-based width logic from date-input component

  In [1.1 release](https://github.com/CautionYourBlast/govuk-frontend/pull/857/files#diff-e94394b2ac1d4f73991af98e4fa34fa3L32)
  ...
  ([PR #969](https://github.com/CautionYourBlast/govuk-frontend/pull/969))
...
- Rename `name` argument of date-input component to `namePrefix`.
  ...
  ([PR #984](https://github.com/CautionYourBlast/govuk-frontend/pull/984))
...
- Turn off [compatibility mode](./docs/installation/installing-with-npm.md#compatibility-mode) by default for [GOV.UK Elements](https://github.com/alphagov/govuk_elements), [GOV.UK Template](https://github.com/alphagov/govuk_template), [GOV.UK Frontend Toolkit](https://github.com/alphagov/govuk_frontend_toolkit)
  ...
  ([PR #981](https://github.com/CautionYourBlast/govuk-frontend/pull/981))
...
- Remove anchor styling in govuk-lists
  ...
  If you would like to replicate this functionality without adding a class you can also enable [global styles](https://github.com/CautionYourBlast/govuk-frontend/blob/master/docs/installation/installing-with-npm.md#global-styles) (Note: global styles are enabled by default in the GOV.UK Prototype Kit)

  ([PR #985](https://github.com/CautionYourBlast/govuk-frontend/pull/985))
...
- Remove the width declaration from the `<select>` component
  ...
  ([PR #960](https://github.com/CautionYourBlast/govuk-frontend/pull/960))
...
- Use text colour on focus for better contrast
  ...
  ([PR #982](https://github.com/CautionYourBlast/govuk-frontend/pull/982))
...
- Allow attributes on select items
  ...
  ([PR #977](https://github.com/CautionYourBlast/govuk-frontend/pull/977))
...
- Textareas can now only be resized vertically, to prevent them being resized
  ...
  ([PR #976](https://github.com/CautionYourBlast/govuk-frontend/pull/976))

- Defend tables against GOV.UK Elements code
  ([PR #983](https://github.com/CautionYourBlast/govuk-frontend/pull/983))
...
- Allow attributes on checkboxes/radios
  ...
  ([PR #942](https://github.com/CautionYourBlast/govuk-frontend/pull/942))
...
- Fix incorrect panel title bottom margin with optional text
  ...
  ([PR #936](https://github.com/CautionYourBlast/govuk-frontend/pull/936))
...
- Remove template whitespace
  ...
  ([PR #949](https://github.com/CautionYourBlast/govuk-frontend/pull/949))
...
- Remove additional dotted outline from focussed buttons in Firefox
  ...
  ([PR #951](https://github.com/CautionYourBlast/govuk-frontend/pull/951))

- Update date input component to use `display: inline-block`
  ([PR #938](https://github.com/CautionYourBlast/govuk-frontend/pull/938))

- Change spacing relationship on default and small legends and hints
  ([PR #940](https://github.com/CautionYourBlast/govuk-frontend/pull/940))

- Adjust tag component padding to compensate for font spacing
  ([PR #955](https://github.com/CautionYourBlast/govuk-frontend/pull/955))
...
- Allow for optional divider between radio items
  ...
  ([PR #849](https://github.com/CautionYourBlast/govuk-frontend/pull/849))
...
- Allow og:image meta tag url to be set independantly
  ...
  ([PR #847](https://github.com/CautionYourBlast/govuk-frontend/pull/847))
...
- Only underline the logo in the header on underline when users have overridden
  ...
  ([PR #926](https://github.com/CautionYourBlast/govuk-frontend/pull/926))
...
- Allow for optional hint for each radio and checkbox item
  ...
  ([PR #846](https://github.com/CautionYourBlast/govuk-frontend/pull/846))
...
- Allow additional classes to be added to the radio and checkbox items
  ...
  ([PR #880](https://github.com/CautionYourBlast/govuk-frontend/pull/880))
...
- Replace conflicting `js-hidden` class used within the tabs component with a new modifier class.
  ...
  ([PR #916](https://github.com/CautionYourBlast/govuk-frontend/pull/916))
- Use `get-function` when calling a Sass function as passing a string to `call()``
  is deprecated and will be illegal in Sass 4.0
  ([PR #919](https://github.com/CautionYourBlast/govuk-frontend/pull/919))
...
- Fix flash of unstyled content with conditional reveals (Radios and Checkboxes)
  ...
  ([PR #885](https://github.com/CautionYourBlast/govuk-frontend/pull/885))
...
- Update details behaviour to remove margin-bottom for all elements
  ([PR #900](https://github.com/CautionYourBlast/govuk-frontend/pull/900))

- Update internal padding of tab content in the tabs component
  ([PR #886](https://github.com/CautionYourBlast/govuk-frontend/pull/886))
...
- Fixes an issue where clicking the revealed content in browsers that do not
  ...
  ([PR #912](https://github.com/CautionYourBlast/govuk-frontend/pull/912))
...
- Fixes an issue where it's not possible to make any field that does not have
  ...
  ([PR #908](https://github.com/CautionYourBlast/govuk-frontend/pull/908))

- Fix undefined class displaying in date input
  ([PR #913](https://github.com/CautionYourBlast/govuk-frontend/pull/913))
...
- Add `govuk-visually-hidden-focusable` class
  ...
  ([PR #859](https://github.com/CautionYourBlast/govuk-frontend/pull/859))
...
- Allow panel component title heading to be customisable.
  ...
  ([PR #853](https://github.com/CautionYourBlast/govuk-frontend/pull/853))
...
- Update date input component
  ...
  ([PR #857](https://github.com/CautionYourBlast/govuk-frontend/pull/857))
...
- The typography scale can now be converted from pixels to rem automatically,
  ...
  <https://github.com/CautionYourBlast/govuk-frontend/issues/868>

  ([PR #858](https://github.com/CautionYourBlast/govuk-frontend/pull/858))

🔧 Fixes:

- Remove mistakenly applied 5px bottom margin from radio and checkbox
  labels.
  ([PR #883](https://github.com/CautionYourBlast/govuk-frontend/pull/883))
...
- Apply `display:block` to `.govuk-main-wrapper`
  ...
  ([PR #863](https://github.com/CautionYourBlast/govuk-frontend/pull/863)))
...
- Line-heights are now converted from pixels to relative 'unit-less' values
  ...
  ([PR #837](https://github.com/CautionYourBlast/govuk-frontend/pull/837) and
  [PR #848](https://github.com/CautionYourBlast/govuk-frontend/pull/848))
...
- Add bottom margin to Tabs component
  ...
  ([PR #841](https://github.com/CautionYourBlast/govuk-frontend/pull/841))
...
- Update Crown copyright link
  ...
  ([PR #824](https://github.com/CautionYourBlast/govuk-frontend/pull/824))

- Fixes radio and checkbox labels extending full width of page
  ([PR #821](https://github.com/CautionYourBlast/govuk-frontend/pull/821))
...
- Prevent the exclamation mark in the warning text component from being
  ...
  of text
  ([PR #856](https://github.com/CautionYourBlast/govuk-frontend/pull/856))
...
- Add customised colours handling for warning text
  ...
  ([PR #852](https://github.com/CautionYourBlast/govuk-frontend/pull/852))

- Fixes a bug where the phase banner incorrectly uses a font-size of 19px when
  global styles are enabled
  ([PR #877](https://github.com/CautionYourBlast/govuk-frontend/pull/877))
...
- Add outlines to Radios and Checkboxes for customised colour users
  ...
  ([PR #854](https://github.com/CautionYourBlast/govuk-frontend/pull/854))

- Add outline to tag for customised colour users

  Now when a [user customises their colours](https://accessibility.blog.gov.uk/2017/03/27/how-users-change-colours-on-websites/),
  the tag component still keeps it's meaning.
  ([PR #855](https://github.com/CautionYourBlast/govuk-frontend/pull/855))
...
- Define size of table in `px` rather than `em`
  ...
  ([PR #845](https://github.com/CautionYourBlast/govuk-frontend/pull/845))
...
- Fix Design System url in package READMEs and review app
  ([PR #812](https://github.com/CautionYourBlast/govuk-frontend/pull/812))

- Update back-link example to show default usage doesn't need
  `text` parameter
  ([PR #819](https://github.com/CautionYourBlast/govuk-frontend/pull/819))

- Lowercase component names
  ([PR #822](https://github.com/CautionYourBlast/govuk-frontend/pull/822))

- Tidy up some package.json fields to help contributors and users
  ([PR #827](https://github.com/CautionYourBlast/govuk-frontend/pull/827))

- Fix failing Heroku app with Node 10.5.0
  Revert to pinning node version in package json
  ([PR #833](https://github.com/CautionYourBlast/govuk-frontend/pull/833))

- Format YAML and Nunjucks consistently
  ([PR #830](https://github.com/CautionYourBlast/govuk-frontend/pull/830))
...
- Add default text for back-link component
  ([PR #793](https://github.com/CautionYourBlast/govuk-frontend/pull/793))

- Add default container class to the header component
  ([PR #807](https://github.com/CautionYourBlast/govuk-frontend/pull/807))
...
- Add tabs component – thanks to [@adamsilver](https://github.com/adamsilver) and [@trevorsaint](https://github.com/trevorsaint) for contributing
  ([PR #776](https://github.com/CautionYourBlast/govuk-frontend/pull/776))
...
- Reduce margin-bottom on the hint when following a default or small labe
  ...
  ([PR #806](https://github.com/CautionYourBlast/govuk-frontend/pull/806))

🏠 Internal:

- Remove instructions to login with npm, which is no longer required
  ([PR #795](https://github.com/CautionYourBlast/govuk-frontend/pull/795))

- Update docs with the assistive technology we support ([PR #800](https://github.com/CautionYourBlast/govuk-frontend/pull/800))

- Update docs about installing fonts ([PR #802](https://github.com/CautionYourBlast/govuk-frontend/pull/802))

- Update browser support matrix
  Remove Windows Phone
  Update IE 8-10 to functional and IE 11 to compliant
  ([PR #803](https://github.com/CautionYourBlast/govuk-frontend/pull/803)

- Add notice about the use of `html` arguments in Nunjucks macros for production
  ([PR #785](https://github.com/CautionYourBlast/govuk-frontend/pull/785))

- Add CHANGELOG_TEMPLATE to make changelogs easier for new contributors
  ([PR #798](https://github.com/CautionYourBlast/govuk-frontend/pull/798))

- Update package `README`
  ([PR #804](https://github.com/CautionYourBlast/govuk-frontend/pull/804))

- Update JavaScript installation instructions
  ([PR #808](https://github.com/CautionYourBlast/govuk-frontend/pull/808))
...
- The default build of the GOV.UK Frontend JavaScript now does not initialize all components automatically.
  ...
  ([PR #759](https://github.com/CautionYourBlast/govuk-frontend/pull/759))
...
- Consistently structure the Details and Button component, so that they can be instantiated the same as the other components.
  ...
  ([PR #761](https://github.com/CautionYourBlast/govuk-frontend/pull/761))
...
- All sass-mq settings have now been made private. We are now exposing new
  ...
  ([PR #748](https://github.com/CautionYourBlast/govuk-frontend/pull/748))
...
- Spacing has been refactored. You will need to update Sass that currently uses GOV.UK Frontend spacing:
  ...
  ([PR #779](https://github.com/CautionYourBlast/govuk-frontend/pull/779))

- Remove `pageStart` block from template, as could result in rendering issues in older IE.
  ([PR #765](https://github.com/CautionYourBlast/govuk-frontend/pull/765))
...
- You should no longer call the `mq` mixin directly - you should replace any
  ...
  ([PR #763](https://github.com/CautionYourBlast/govuk-frontend/pull/763))
...
- All of the shorthand 'font' mixins (e.g. `govuk-font-bold-80`,
  ...
  ([PR #772](https://github.com/CautionYourBlast/govuk-frontend/pull/772))
...
- The 'circle shape' object (`.govuk-circle`) which was used by the warning text
  ...
  ([PR #782](https://github.com/CautionYourBlast/govuk-frontend/pull/782))
...
- Removal of `govuk-prose-scope`
  ...
  In version [0.0.29-alpha](https://github.com/CautionYourBlast/govuk-frontend/releases/tag/v0.0.29-alpha)
  ...
  ([PR #778](https://github.com/CautionYourBlast/govuk-frontend/pull/778))
...
- Make override classes consistently verbose
  ...
  ([PR #786](https://github.com/CautionYourBlast/govuk-frontend/pull/786))

🔧 Fixes:

- Fix govuk-equilateral-height function usage in shape-arrow helper
  ([PR ##766](https://github.com/CautionYourBlast/govuk-frontend/pull/766))
...
- The `<label>` element will now be omitted for form controls where no label
  ...
  ([PR #740](https://github.com/CautionYourBlast/govuk-frontend/pull/740))

- Add `govuk-main-wrapper` to `<main>` element by default.
  ([PR #742](https://github.com/CautionYourBlast/govuk-frontend/pull/742))
...
- Use relative imports whenever a component imports another component, to allow
  ...
  nunjucks paths.
  ([PR #743](https://github.com/CautionYourBlast/govuk-frontend/pull/743))
...
- Update JavaScript global namespace from 'all' to 'GOVUKFrontend',
  ...
  ([PR #747](https://github.com/CautionYourBlast/govuk-frontend/pull/747))
...
- Prevents focus from being lost to the inline SVGs in the header (the crown)
  ...
  ([PR #774](https://github.com/CautionYourBlast/govuk-frontend/pull/774))

- Use the correct class name in bold label example
  (govuk-label--s rather than govuk-label--bold)
  ([PR #784](https://github.com/CautionYourBlast/govuk-frontend/pull/784))

- Update table of arguments for each component to ensure they're accurate.
  ([PR #769](https://github.com/CautionYourBlast/govuk-frontend/pull/769))

- Add explicit dependency on colour maps
  ([PR #790](https://github.com/CautionYourBlast/govuk-frontend/pull/790))
...
- Most of the settings, helpers and tools layers is now documented using
  ...
  public.
  ([PR #748](https://github.com/CautionYourBlast/govuk-frontend/pull/748))
  ([PR #762](https://github.com/CautionYourBlast/govuk-frontend/pull/762))
...
- Improve release steps
  ([PR #745](https://github.com/CautionYourBlast/govuk-frontend/pull/745))

- Reintroduce mistakenly deleted HTML5Shiv required for IE8
  ([PR #749](https://github.com/CautionYourBlast/govuk-frontend/pull/749))

- Fix issues with canvas colour bleeding into main review page
  ([PR #741](https://github.com/CautionYourBlast/govuk-frontend/pull/741))

- Add header with service name and navigation variant to header README ([PR #781](https://github.com/CautionYourBlast/govuk-frontend/pull/781))
...
- The `govuk-file-url` helper has been renamed to to `govuk-image-url`. If you
  ...
  it. ([PR #726](https://github.com/CautionYourBlast/govuk-frontend/pull/726))
...
- The `$govuk-global-images` variable has been renamed to to
  ...
  ([PR #726](https://github.com/CautionYourBlast/govuk-frontend/pull/726))

🔧 Fixes:

- Namespacing SCSS exports with 'govuk' prefix to avoid clashes with
  exports in applications consuming GOV.UK Frontend
  ([PR #732](https://github.com/CautionYourBlast/govuk-frontend/pull/732))
...
- Removed some duplicated CSS rules from the outputted CSS
  ([PR #727](https://github.com/CautionYourBlast/govuk-frontend/pull/727))
...
- Fixes a bug in IE8 where the button component did not have a shadow, by
  ...
  support box-shadow
  ([PR #737](https://github.com/CautionYourBlast/govuk-frontend/pull/737))
...
- You can now override the helpers used to generate image and font urls, for
  ...
  ([PR #733](https://github.com/CautionYourBlast/govuk-frontend/pull/733))

- Add boilerplate template, which is a Nunjucks replacement for [GOV.UK Template](https://github.com/alphagov/govuk_template).
  ([PR #731](https://github.com/CautionYourBlast/govuk-frontend/pull/731))

🏠 Internal:

- Improve release steps, based on doing a release
  ([PR #725](https://github.com/CautionYourBlast/govuk-frontend/pull/725))

- Fix majority of vulnerabilities flagged by `npm audit`
  ([PR #712](https://github.com/CautionYourBlast/govuk-frontend/pull/712))
...
- Update component readme files content
  ([PR #704](https://github.com/CautionYourBlast/govuk-frontend/pull/704))

- Fix panel body element rendering with no text
  ([PR #707](https://github.com/CautionYourBlast/govuk-frontend/pull/707))

🆕 New features:

- Add override classes to set `display` property to `block`, `inline` and `inline-block` (PR [#694](https://github.com/CautionYourBlast/govuk-frontend/pull/654))

- Add option to set CSS display property for govuk-shape-arrow mixin
  ([PR #701](https://github.com/CautionYourBlast/govuk-frontend/pull/701))

- Add header component (PR [#695](https://github.com/CautionYourBlast/govuk-frontend/pull/695))

- Add inset text component (PR [#709](https://github.com/CautionYourBlast/govuk-frontend/pull/709))

- Add ability to pass explicit name value to checkbox items (PR [#719](https://github.com/CautionYourBlast/govuk-frontend/pull/719))

🏠 Internal:

- Run tests in pre-release
  ([PR #706](https://github.com/CautionYourBlast/govuk-frontend/pull/706))

- Fix CI timeouts: run Jest single thread in TravisCI
  ([PR #712](https://github.com/CautionYourBlast/govuk-frontend/pull/712))

- Ensure 'after' tests are not ignored
  ([PR #720](https://github.com/CautionYourBlast/govuk-frontend/pull/720))
...
- Restructure project to enable it to be published as a single package
  ...
  ([PR #680](https://github.com/CautionYourBlast/govuk-frontend/pull/680))
...
- Error Messages and Hints have been moved out Label and Fieldset components.
  ...
  ([PR #681](https://github.com/CautionYourBlast/govuk-frontend/pull/681))
...
- The label component macro now accepts an `isPageHeading` argument which determines
  ...
  ([PR #684](https://github.com/CautionYourBlast/govuk-frontend/pull/684))
...
- Remove -c -o -h layer prefixes
  ([PR #644](https://github.com/CautionYourBlast/govuk-frontend/pull/644))
...
- Simplify grid syntax and introduce grid-row and column mixins.
  ...
  ([PR #665](https://github.com/CautionYourBlast/govuk-frontend/pull/665))
...
- Remove redundant font-family declaration from the button component – this will
  ...
  (PR [#650](https://github.com/CautionYourBlast/govuk-frontend/pull/650))

- Reinstate focus outline for radios and checkboxes on IE8
  (PR [#670](https://github.com/CautionYourBlast/govuk-frontend/pull/670))

- Fix section break styles when used with GOV.UK Elements
  ([PR #682](https://github.com/CautionYourBlast/govuk-frontend/pull/682))

- Remove `-webkit-tap-highlight-color` from links (PR [#692](https://github.com/CautionYourBlast/govuk-frontend/pull/692))

- Remove normalize from /dist builds
  (PR [#699](https://github.com/CautionYourBlast/govuk-frontend/pull/699))

🆕 New features:

- We're now using ES6 Modules and [rollup](https://rollupjs.org/guide/en) to distribute our JavaScript. (PR [#652](https://github.com/CautionYourBlast/govuk-frontend/pull/652))
- Checkboxes and Radios conditional reveal
  (PR [#616](https://github.com/CautionYourBlast/govuk-frontend/pull/616))

- Vendor-in SassMQ functionality, write tests and remove external dependency
  (PR [#657](https://github.com/CautionYourBlast/govuk-frontend/pull/657))

- Focus Error Summary on window load
  (PR [#671](https://github.com/CautionYourBlast/govuk-frontend/pull/671))

- Opt-in Global `<a>` and `<p>` styles
  (PR [#658](https://github.com/CautionYourBlast/govuk-frontend/pull/658))
...
- Remove unused step in travis.yml file
  (PR [#690](https://github.com/CautionYourBlast/govuk-frontend/pull/690))
- Update publishing docs (PR [#651](https://github.com/CautionYourBlast/govuk-frontend/pull/651))
- Wrap `app.css` in conditional comments in review app layout (PR [#653](https://github.com/CautionYourBlast/govuk-frontend/pull/653))
- Fix missing code highlight and remove duplicate layout
  (PR [#663](https://github.com/CautionYourBlast/govuk-frontend/pull/663))
- Exclude test related files from `dist/` and `packages/` copy task
  (PR [#662](https://github.com/CautionYourBlast/govuk-frontend/pull/662))
- Add test to check if Sass in packages compiles correctly after the `build:packages` task
  (PR [#669](https://github.com/CautionYourBlast/govuk-frontend/pull/669))
- Disable code syntax highlighting in IE8
  (PR [#675](https://github.com/CautionYourBlast/govuk-frontend/pull/675))
- Simplify contents of the `dist/` folder
  (PR [#673](https://github.com/CautionYourBlast/govuk-frontend/pull/673))
...
- Removed an (undocumented) modifier `govuk-c-radio__item--inline` which made
  ...
  (PR [#607](https://github.com/CautionYourBlast/govuk-frontend/pull/607))
- Prefix `$global-images` variable
  (PR [#615](https://github.com/CautionYourBlast/govuk-frontend/pull/615))
- Simplified how we build stylesheets that target old versions of IE:
  ...
  details.
  (PR [#631](https://github.com/CautionYourBlast/govuk-frontend/pull/631))

- Rename captionSize table argument to captionClasses ([PR #643](https://github.com/CautionYourBlast/govuk-frontend/pull/643))
...
- Link styles, as well as links within the back-link, breadcrumbs, button,
  ...
  (PR [#609](https://github.com/CautionYourBlast/govuk-frontend/pull/609))
- Fix table captions to allow heading classes
  (PR [#633](https://github.com/CautionYourBlast/govuk-frontend/pull/633))
...
- Add `govuk-main-wrapper--l` a variant of the main page wrapper to use when a
  ...
  (PR [#602](https://github.com/CautionYourBlast/govuk-frontend/pull/602))
...
- Add limited width inputs
  (PR [#626](https://github.com/CautionYourBlast/govuk-frontend/pull/626))
- Add details polyfill. This is automatically initialised in the main JS. (PR [#610](https://github.com/CautionYourBlast/govuk-frontend/pull/610))
- Add button polyfill. This is automatically initialised in the main JS. [#572](https://github.com/CautionYourBlast/govuk-frontend/pull/572))
...
- Update check script for new components and tweak docs
  (PR [#589](https://github.com/CautionYourBlast/govuk-frontend/pull/589))
- Listen for development server on different port for tests
  (PR [#622](https://github.com/CautionYourBlast/govuk-frontend/pull/622))

- Fix date-input default example
  (PR [#623](https://github.com/CautionYourBlast/govuk-frontend/pull/623))
- Ensure we're testing error-messages in date-input
  (PR [#625](https://github.com/CautionYourBlast/govuk-frontend/pull/625))

- Explain npm link
  (PR [#624](https://github.com/CautionYourBlast/govuk-frontend/pull/624))

- Make Sass imports less broad
  (PR [#617](https://github.com/CautionYourBlast/govuk-frontend/pull/617))

- Update project README with user research findings (PR [#617](https://github.com/CautionYourBlast/govuk-frontend/pull/615))

- Update component READMEs to use `import` statement (PR [#615](https://github.com/CautionYourBlast/govuk-frontend/pull/615))

- Use promisify util instead of manual method (PR [#639](https://github.com/CautionYourBlast/govuk-frontend/pull/639))
...
- The error summary component now has a default bottom margin
  (PR [#583](https://github.com/CautionYourBlast/govuk-frontend/pull/583))
- Nest components correctly
  (PR [#584](https://github.com/CautionYourBlast/govuk-frontend/pull/584))

🔧 Fixes:

- Make section break line 1px instead of 2px
  (PR [#585](https://github.com/CautionYourBlast/govuk-frontend/pull/585))

🆕 New features:

- Add footer component (PR [#569](https://github.com/CautionYourBlast/govuk-frontend/pull/569))

🏠 Internal:

- Update pre-release step to check for new components
  (PR [#574](https://github.com/CautionYourBlast/govuk-frontend/pull/574))
- Ensure render function does not have undefined object
  (PR [#587](https://github.com/CautionYourBlast/govuk-frontend/pull/587))
- Fix components relying on global builds
  (PR [#588](https://github.com/CautionYourBlast/govuk-frontend/pull/588))
...
- The colour variable `$govuk-fuschia` has been replaced with a new variable
  ...
  (PR [#571](https://github.com/CautionYourBlast/govuk-frontend/pull/571))

🆕 New features:

- The input macro now accepts a `type` which allows you to override the default
  type="text" (PR [#568](https://github.com/CautionYourBlast/govuk-frontend/pull/568))
...
- The transparent outline has been removed from the button, as it already has
  ...
  (PR [#552](https://github.com/CautionYourBlast/govuk-frontend/pull/552))
...
- The date input component now sets `type="number"` and `pattern="[0-9]*"` to
  ...
  (PR [#568](https://github.com/CautionYourBlast/govuk-frontend/pull/568))
...
- Fixes for the release process
  (PR [#567](https://github.com/CautionYourBlast/govuk-frontend/pull/567))
- Add HTML5-shiv to review app
  (PR [#575](https://github.com/CautionYourBlast/govuk-frontend/pull/575))

## 0.0.24-alpha (Breaking release)

💥 Breaking changes:

- Namespace existing mixins and functions ( PR [#557](https://github.com/CautionYourBlast/govuk-frontend/pull/557))
- The class `.govuk-section-break__visible` has been renamed to
  `.govuk-section-break--visible` as it is a modifier, not an element.
  (PR [#547](https://github.com/CautionYourBlast/govuk-frontend/pull/547))
- Simplify `src/` folder structure, remove tree and string manipulations from
  gulp tasks (PR [#545](https://github.com/CautionYourBlast/govuk-frontend/pull/545))
...
- A new variable `$govuk-input-border-colour` has been introduced to define the
  ...
  updated to use it.
  (PR [#551](https://github.com/CautionYourBlast/govuk-frontend/pull/551))

🔧 Fixes:

- Removes media query display on body from compiled CSS
  (PR [#560](https://github.com/CautionYourBlast/govuk-frontend/pull/560))

- Fieldset legends now correctly use 'full black' text colour when printed
  (PR [#544](https://github.com/CautionYourBlast/govuk-frontend/pull/544))
...
- The 'prose scope' has been updated to extend only placeholder classes. The
  ...
  (PR [#550](https://github.com/CautionYourBlast/govuk-frontend/pull/550))
...
- Release process has been streamlined with fewer steps
  (PR [#553](https://github.com/CautionYourBlast/govuk-frontend/pull/553))
- Update `govuk-section-break__visible` new class name `govuk-section-break--visible` in the review app's Typography page.
  (PR [#566](https://github.com/CautionYourBlast/govuk-frontend/pull/566))
...
- Remove Cookie-banner and Previous-next components
  (PR [#488](https://github.com/CautionYourBlast/govuk-frontend/pull/488), PR [#523](https://github.com/CautionYourBlast/govuk-frontend/pull/523))
- Remove unused colours from the 'applied' colour palette:
  (PR [#525](https://github.com/CautionYourBlast/govuk-frontend/pull/525))
  - `$govuk-panel-colour`
  - `$govuk-canvas-colour`
...
- Button hover colour now has a semantic Sass name: $govuk-button-hover-colour
  (PR [#406](https://github.com/CautionYourBlast/govuk-frontend/pull/406))
- A new link variant has been added which removes the visited state, for cases
  ...
  (PR [#446](https://github.com/CautionYourBlast/govuk-frontend/pull/446))
- The responsive spacing and typography mixins will now throw an error if you
  ...
  (PR [#447](https://github.com/CautionYourBlast/govuk-frontend/pull/447))
- Add thematic break to typography and prose scope. This class is added to an
  ...
  border visible or invisible. (PR [#483](https://github.com/CautionYourBlast/govuk-frontend/pull/483))

🔧 Fixes:

- Remove double margin from Date input component
  (PR [#451](https://github.com/CautionYourBlast/govuk-frontend/pull/451))
- Add top margin for nested lists (PR [#464](https://github.com/CautionYourBlast/govuk-frontend/pull/464))
- Remove regular font weight from link styles (PR [#469](https://github.com/CautionYourBlast/govuk-frontend/pull/469))
- Remove redundant 'govuk-c-border' div from the details component
  (PR [#481](https://github.com/CautionYourBlast/govuk-frontend/pull/481))
- Add `govuk-c-select--error` modifier class to the select component instead of relying on `govuk-c-input--error` (PR [#506](https://github.com/CautionYourBlast/govuk-frontend/pull/506))
- Allow error message and hint text to be passed to a select component without requiring a label parameter (PR [#506](https://github.com/CautionYourBlast/govuk-frontend/pull/506))
- Define size of inputs etc in `px` rather than `em`. (PR [#491](https://github.com/CautionYourBlast/govuk-frontend/pull/491))
- Remove scope=row attribute from non-th elements (PR [527](https://github.com/CautionYourBlast/govuk-frontend/pull/527))
- Form components and fieldset now include `govuk-o-form-group` that sets left
  ...
  (PR [#591](https://github.com/CautionYourBlast/govuk-frontend/pull/591))
...
- Replace Mocha/Chai with Jest, re-enable task tests, add back-link component.
  ...
  (PR [#455](https://github.com/CautionYourBlast/govuk-frontend/pull/455))
- Add example of nested lists to typography and prose scope in review app (PR [#464](https://github.com/CautionYourBlast/govuk-frontend/pull/464))
- Add tests for tag component (PR [#457](https://github.com/CautionYourBlast/govuk-frontend/pull/457))
- Add tests for button component (PR [#461](https://github.com/CautionYourBlast/govuk-frontend/pull/461))
- Add tests for breadcrumbs component (PR [#461](https://github.com/CautionYourBlast/govuk-frontend/pull/461))
- Add tests for details component (PR [#480](https://github.com/CautionYourBlast/govuk-frontend/pull/480))
- Add tests for warning text component (PR [#479](https://github.com/CautionYourBlast/govuk-frontend/pull/479))
- Add tests for table component (PR [#472](https://github.com/CautionYourBlast/govuk-frontend/pull/472))
- Add tests for error-summary component (PR [#489](https://github.com/CautionYourBlast/govuk-frontend/pull/489))
- Add tests for radios component (PR [#476](https://github.com/CautionYourBlast/govuk-frontend/pull/476))
- Add tests for input component (PR [#478](https://github.com/CautionYourBlast/govuk-frontend/pull/478))
- Add tests for date-input component (PR [#495](https://github.com/CautionYourBlast/govuk-frontend/pull/495))
- Add tests for textarea component (PR [#497](https://github.com/CautionYourBlast/govuk-frontend/pull/497))
- Add tests for panel component (PR [#500](https://github.com/CautionYourBlast/govuk-frontend/pull/500))
- Add tests for skip-link component (PR [#498](https://github.com/CautionYourBlast/govuk-frontend/pull/498))
- Add tests for file-upload component (PR [#504](https://github.com/CautionYourBlast/govuk-frontend/pull/504))
- Add tests for error-message component (PR [#507](https://github.com/CautionYourBlast/govuk-frontend/pull/507))
- Add tests for phase-banner component (PR [#505](https://github.com/CautionYourBlast/govuk-frontend/pull/505))
- Add tests for label component component (PR [#508](https://github.com/CautionYourBlast/govuk-frontend/pull/508))
- Add tests for fieldset component (PR [#509](https://github.com/CautionYourBlast/govuk-frontend/pull/509))
- Add tests for select component (PR [#506](https://github.com/CautionYourBlast/govuk-frontend/pull/506))
- Add tests for checkboxes component (PR [#513](https://github.com/CautionYourBlast/govuk-frontend/pull/513))
- Add tests to make sure the examples pages render without errors [#523](https://github.com/CautionYourBlast/govuk-frontend/pull/523)
- Add correct links to the guidance in the Design System in component READMEs
  (PR [#528](https://github.com/CautionYourBlast/govuk-frontend/pull/528))
...
- The link styles in the core layer no longer style `a` elements directly, but
  ...
  individually. (PR [#427](https://github.com/CautionYourBlast/govuk-frontend/pull/427))
- The link component has been removed from Frontend as the link styles have
  been moved to the core
  (PR [#431](https://github.com/CautionYourBlast/govuk-frontend/pull/431))
- Rename `legal-text` argument accepted by `legal-text` component to `text` (PR [#431](https://github.com/CautionYourBlast/govuk-frontend/pull/432))
- Rename `legal-text` component to `warning-text` (PR [#431](https://github.com/CautionYourBlast/govuk-frontend/pull/432))
...
- The prose scope has been extended to style links, which means links within the
  ...
  (PR [#427](https://github.com/CautionYourBlast/govuk-frontend/pull/427))
...
- The error summary component allows users to pass HTML for an entry in the list
  again. (PR [#428](https://github.com/CautionYourBlast/govuk-frontend/pull/428))
- Error list entries in the error summary component no longer get wrapped in
  links when no `href` is provided.
  (PR [#428](https://github.com/CautionYourBlast/govuk-frontend/pull/428))
...
- Add prose scope example (PR [#429](https://github.com/CautionYourBlast/govuk-frontend/pull/429))
- Links within the review app and the examples have been updated to use the
  `govuk-link` class.
  (PR [#427](https://github.com/CautionYourBlast/govuk-frontend/pull/427))
- Improve documentation around publishing (PR [#430](https://github.com/CautionYourBlast/govuk-frontend/pull/430))
- Improve documentation around contributing (PR [#433](https://github.com/CautionYourBlast/govuk-frontend/pull/433))
- Remove readme content from review app (PR [#482](https://github.com/CautionYourBlast/govuk-frontend/pull/482))
...
- Rename ‘govuk-body-lede’ to ‘govuk-body-lead’. (PR [#405](https://github.com/CautionYourBlast/govuk-frontend/pull/405))
- Pluralise radio component (PR [#388](https://github.com/CautionYourBlast/govuk-frontend/pull/388))
- Pluralise checkbox component (PR [#384](https://github.com/CautionYourBlast/govuk-frontend/pull/384))

🆕 New features:

- Add `width` classes, which were based on `form-control` classes that were
  specific to form control in Elements. (PR [#413](https://github.com/CautionYourBlast/govuk-frontend/pull/413))

🔧 Fixes:

- Make buttons 40px high including box shadow (PR [#416](https://github.com/CautionYourBlast/govuk-frontend/pull/416))
- Fix focus outline style in Chrome and Safari (PR [#414](https://github.com/CautionYourBlast/govuk-frontend/pull/414))
- Remove contributors list from template, fix template markup and update README files (PR [#403](https://github.com/CautionYourBlast/govuk-frontend/pull/403))
- Generate breadcrumb chevrons using pseudo-elements (PR [#407](https://github.com/CautionYourBlast/govuk-frontend/pull/407))
- Fix undefined classes in date input macro (PR [#410](https://github.com/CautionYourBlast/govuk-frontend/pull/410))
- Add documentation for typography helpers / core, simplify syntax (PR [#400](https://github.com/CautionYourBlast/govuk-frontend/pull/400))
- Add adjacent styles for headings after lists (PR [#408](https://github.com/CautionYourBlast/govuk-frontend/pull/408))
- Allow line height to be overridden in typography helpers (PR [#404](https://github.com/CautionYourBlast/govuk-frontend/pull/404))
